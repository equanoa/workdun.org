...
import { Shield, Users, Zap, Target, TrendingUp, Rocket } from 'lucide-react'
...
export function Features8() {
    return (
        <section className="bg-white pt-8 md:pt-12 pb-16 md:pb-32 relative overflow-hidden">
            <div className="mx-auto max-w-3xl lg:max-w-5xl px-6 relative z-10">
                <div className="relative">
                    <div className="relative z-10 grid grid-cols-6 gap-4 md:gap-5">
                        ...
                        >
                            <Card className="relative flex overflow-hidden border-border bg-white hover:shadow-xl transition-all duration-500 cursor-pointer group h-full">
                                <CardContent className="relative m-auto size-fit pt-6 w-full">
                                    ...
                                    <h2 className="mt-6 text-center text-3xl font-semibold text-foreground">Tailored Solutions</h2>
                                    <p className="mt-4 text-center text-sm text-muted-foreground px-4">
                                        Fully adaptable platforms designed to evolve with your unique business requirements and growth trajectory.
                                    </p>
                                </CardContent>
                            </Card>
                        </motion.div>
                        ...
                        >
                            <Card className="relative overflow-hidden border-border bg-white hover:shadow-xl transition-all duration-500 cursor-pointer group h-full flex flex-col">
                                <CardContent className="pt-6 flex-1 flex flex-col items-center justify-center">
                                    <div className="relative mx-auto flex aspect-square size-32 rounded-full border border-border before:absolute before:-inset-2 before:rounded-full before:border before:border-border">
                                    ...
                                    <div className="relative z-10 mt-6 space-y-2 text-center flex-1 flex flex-col justify-center">
                                        <h2 className="text-lg font-medium text-foreground">Enterprise-Grade Security</h2>
                                        <p className="text-muted-foreground text-sm">Built-in security protocols and compliance frameworks that safeguard your critical business assets and ensure regulatory adherence.</p>
                                    </div>
                                </CardContent>
                            </Card>
                        </motion.div>
                        ...
                        >
                            <Card className="relative overflow-hidden border-border bg-white hover:shadow-xl transition-all duration-500 cursor-pointer group h-full flex flex-col">
                                <CardContent className="pt-6 flex-1 flex flex-col">
                                    <div className="pt-6 lg:px-6 flex-1 flex items-center justify-center">
                                    <svg className="w-full" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect width="386" height="123" rx="10" className="fill-gray-100" />
                                        <g clipPath="url(#clip0_0_106)">
                                            <circle className="text-muted-foreground" cx="29" cy="29" r="15" fill="currentColor" />
                                    ...
                                    <div className="relative z-10 mt-6 md:mt-8 space-y-2 text-center">
                                        <h2 className="text-lg font-medium text-foreground">Optimized Performance</h2>
                                        <p className="text-muted-foreground text-sm">High-velocity infrastructure engineered for exceptional speed and seamless scalability to support your evolving business demands.</p>
                                    </div>
                                </CardContent>
                            </Card>
                        </motion.div>
                        ...
                        >
                            <Card className="relative overflow-hidden border-border bg-white hover:shadow-xl transition-all duration-500 cursor-pointer group h-full">
                                <CardContent className="grid pt-6 sm:grid-cols-2 h-full">
                                    ...
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium text-foreground">Comprehensive Protection</h2>
                                        <p className="text-muted-foreground">Multi-layered security architecture with advanced threat detection and data encryption protocols.</p>
                                    </div>
                                </div>
                                <div className="relative -mb-6 -mr-6 mt-6 h-fit border-l border-t border-border p-6 py-6 sm:ml-6">
                        ...
                        >
                            <Card className="relative overflow-hidden border-border bg-white hover:shadow-xl transition-all duration-500 cursor-pointer group h-full">
                                <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                    ...
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium text-foreground">Strategic Partnership</h2>
                                        <p className="text-muted-foreground">A dedicated team of specialists providing continuous support, strategic guidance, and proactive solutions to drive your success.</p>
                                    </div>
                                </div>
                                <div className="relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px before:border-l before:border-border sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border border-border bg-white px-2 py-1 text-xs shadow-sm text-foreground">Team Lead</span>
                                            <div className="ring-white size-7 ring-4">
                                                <div className="size-full rounded-full bg-secondary/200 flex items-center justify-center text-white text-xs font-semibold">A</div>
                                            </div>
                                        </div>
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                            <div className="ring-white size-8 ring-4">
                                                <div className="size-full rounded-full bg-secondary/200 flex items-center justify-center text-white text-xs font-semibold">M</div>
                                            </div>
                                            <span className="block h-fit rounded border border-border bg-white px-2 py-1 text-xs shadow-sm text-foreground">Manager</span>
                                        </div>
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border border-border bg-white px-2 py-1 text-xs shadow-sm text-foreground">Director</span>
                                            <div className="ring-white size-7 ring-4">
                                                <div className="size-full rounded-full bg-secondary/200 flex items-center justify-center text-white text-xs font-semibold">D</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>

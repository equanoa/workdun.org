...
const services = [
  {
    ...
    description: "Modernize your core banking infrastructure with secure, scalable solutions that handle transactions, accounts, and customer data efficiently."
  },
  {
    icon: <Shield className="h-6 w-6" />,
    title: "Financial Security & Compliance",
    description: "Ensure regulatory compliance and protect sensitive financial data with robust security frameworks and audit trails."
  },
  {
    icon: <CreditCard className="h-6 w-6" />,
    title: "Payment Processing Solutions",
    description: "Streamline payment operations with integrated payment gateways, mobile wallets, and digital transaction systems."
  },
  {
    icon: <TrendingUp className="h-6 w-6" />,
    title: "Investment & Trading Platforms",
    description: "Build sophisticated trading platforms, portfolio management systems, and investment analytics tools."
  },
  {
    icon: <Lock className="h-6 w-6" />,
    title: "Fraud Detection & Prevention",
    description: "Implement AI-powered fraud detection systems that identify and prevent fraudulent activities in real-time."
  },
  {
    icon: <BarChart3 className="h-6 w-6" />,
    title: "Financial Analytics & Reporting",
    description: "Transform data into actionable insights with advanced analytics, reporting dashboards, and business intelligence tools."
  },
  {
    icon: <Wallet className="h-6 w-6" />,
    title: "Digital Banking Solutions",
    description: "Create seamless digital banking experiences with mobile apps, online banking platforms, and customer portals."
  },
  {
    icon: <FileText className="h-6 w-6" />,
    title: "Loan Management Systems",
    description: "Automate loan origination, processing, and servicing with comprehensive loan management platforms."
  }
]
...
const benefits = [
  {
    ...
    description: "Enterprise-level security with encryption, multi-factor authentication, and fraud prevention to protect financial data."
  },
  {
    icon: <Building2 className="h-8 w-8" />,
    title: "Regulatory Compliance",
    description: "Solutions designed to meet stringent financial regulations and compliance standards for peace of mind."
  },
  {
    icon: <TrendingUp className="h-8 w-8" />,
    title: "Scalable Architecture",
    description: "Systems built to handle high transaction volumes and scale with your business growth seamlessly."
  },
  {
    icon: <Zap className="h-8 w-8" />,
    title: "Operational Efficiency",
    description: "Streamline financial operations with automated processes and integrated systems for maximum productivity."
  },
  {
    icon: <Target className="h-8 w-8" />,
    title: "Customized Solutions",
    description: "Tailored financial technology solutions designed specifically for your banking needs and objectives."
  },
  {
    icon: <Clock className="h-8 w-8" />,
    title: "24/7 Support",
    description: "Round-the-clock monitoring and support to ensure optimal performance and uptime for critical systems."
  }
]
...
const processSteps = [
  {
    ...
    description: "We analyze your current banking infrastructure, understand your financial needs, and identify opportunities for improvement."
  },
  {
    number: "02",
    title: "Solution Design",
    description: "Our experts design custom financial solutions tailored to your unique requirements and regulatory compliance needs."
  },
  {
    number: "03",
    title: "Implementation & Integration",
    description: "We implement solutions with minimal disruption and seamlessly integrate with your existing banking systems."
  },
  {
    number: "04",
    title: "Support & Optimization",
    description: "Continuous monitoring, optimization, and support to ensure your financial systems drive maximum value."
  }
]
    ...
    <div style={{ backgroundColor: 'white' }} className="pt-16">
      ...
      >
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            >
              Banking and <span className="bg-gradient-to-r from-primary via-blue-400 to-white bg-clip-text text-transparent animate-gradient bg-[length:200%_auto]">Finance</span>
            </motion.h1>
            <motion.p
            ...
            >
              Empowering financial institutions with secure, scalable technology solutions that drive innovation, enhance customer experience, and ensure regulatory compliance.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          >
            {[
              { value: 160, suffix: "+", label: "Financial Institutions" },
              { value: 96, suffix: "%", label: "Client Satisfaction" },
              { value: 24, suffix: "/7", label: "Support" },
              { value: 200, suffix: "%", label: "Avg Efficiency Gain" }
            ].map((stat, index) => (
              <motion.div
                key={index}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                Struggling with Financial <span style={{ color: 'hsl(var(--primary))' }}>Challenges?</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-6">
                Many financial institutions face challenges with legacy systems, regulatory compliance, and digital transformation that limit growth.
              </p>
              <ul className="space-y-4 mb-8">
                {[
                  ...
                  "Lack of security and fraud prevention",
                  "Challenges scaling financial operations"
                ].map((item, index) => (
                  <motion.li
                    key={index}
            ...
            >
              ...
              <p className="text-foreground mb-6">
                Our comprehensive banking and finance services empower financial institutions. We transform your banking infrastructure with secure, scalable, and compliant financial technology solutions.
              </p>
              <a
                href="#contact-form"
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Our Financial <span style={{ color: 'hsl(var(--primary))' }}>Solutions</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Comprehensive fintech services designed to modernize your banking infrastructure and streamline financial operations.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white relative">
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Why Choose Our Financial <span style={{ color: 'hsl(var(--primary))' }}>Solutions?</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Enterprise-grade financial technology services with proven results and comprehensive support.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 via-white to-gray-50 relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Our Financial <span style={{ color: 'hsl(var(--primary))' }}>Process</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              From analysis to optimization, we guide you through every step of your financial technology journey.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                Comprehensive Financial <span style={{ color: 'hsl(var(--primary))' }}>Capabilities</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-4">
                Our financial services cover every aspect of banking, from core systems to digital banking and fraud prevention.
              </p>
              <p className="text-sm text-muted-foreground mb-8">
                We deliver end-to-end financial technology solutions that transform your banking infrastructure into modern, secure, and efficient systems.
              </p>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-extrabold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-6">Financial Stats</h3>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">Enterprise-grade security and data protection. Your financial data is safe with us.</p>
            </div>
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-secondary/20 mb-4" style={{ color: 'hsl(var(--primary))' }}>
              ...
              <p className="text-muted-foreground">We're committed to your success. Our team works closely with you to ensure you achieve your financial technology goals.</p>
            </div>
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-secondary/20 mb-4" style={{ color: 'hsl(var(--primary))' }}>
              ...
              <p className="text-muted-foreground">Get your financial systems ready in 4-8 weeks. Start modernizing immediately.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Trusted by Leading <span style={{ color: 'hsl(var(--primary))' }}>Financial Institutions</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              See how financial institutions have successfully modernized their banking infrastructure with our services.
            </p>
          </motion.div>
          ...
          {(() => {
            const testimonials = [
              {
                quote: "The core banking systems modernization completely transformed our operations. Transaction processing improved by 270%, and customer satisfaction increased by 195%. The financial technology approach delivered measurable results.",
                name: "Rajesh Kumar",
                role: "CTO, RegionalBank",
                location: "Mumbai, Maharashtra",
                metric: "270% Processing",
                metricLabel: "improvement in transaction processing"
              },
              {
                quote: "The payment processing solutions exceeded our expectations. We now have seamless payment operations, and transaction success rate has increased dramatically.",
                name: "Priya Sharma",
                role: "CEO, FinTechSolutions",
                location: "Delhi, NCR",
                metric: "94% Success",
                metricLabel: "transaction success rate increase"
              },
              {
                quote: "The fraud detection system made everything secure. Our fraud detection now has AI-powered prevention, and security incidents have decreased by 98%.",
                name: "Amit Patel",
                role: "Founder, SecureBank",
                location: "Bangalore, Karnataka",
                metric: "98% Reduction",
                metricLabel: "reduction in security incidents"
              },
              {
                quote: "The digital banking solutions streamlined our customer experience. Digital adoption improved by 230%, and our platform is now more user-friendly.",
                name: "Anjali Reddy",
                role: "Founder, DigitalBank",
                location: "Hyderabad, Telangana",
                metric: "230% Adoption",
                metricLabel: "improvement in digital adoption"
              },
              {
                quote: "The financial analytics elevated our decision-making significantly. Data insights improved, and business performance has increased by 185%.",
                name: "Vikram Singh",
                role: "Owner, AnalyticsBank",
                location: "Pune, Maharashtra",
                metric: "185% Performance",
                metricLabel: "increase in business performance"
              },
              {
                quote: "The loan management system implementation was comprehensive. We now have automated loan processing, and operational efficiency has increased by 240%.",
                name: "Kavita Desai",
                role: "Director, LendingBank",
      ...
      <section className="py-16 bg-white border-t border-gray-100">
        <div className="mx-auto max-w-7xl px-6">
          ...
          >
            <p className="text-sm font-semibold text-muted-foreground mb-6">Trusted by Leading Financial Institutions Globally</p>
            <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 opacity-60">
              {["RegionalBank", "FinTechSolutions", "SecureBank", "DigitalBank", "AnalyticsBank", "LendingBank"].map((name, i) => (
                <motion.div
                  key={name}
        ...
        <div className="mx-auto max-w-4xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Everything you need to know about our banking and finance services.
            </p>
          ...
          <div className="space-y-6">
            {[
              {
                category: "Process",
                question: "How long does financial system implementation take?",
                answer: "Implementation timelines vary based on scope and complexity. Most financial system projects are completed within 4-8 weeks, while comprehensive core banking modernizations may take 10-16 weeks. We work closely with you to ensure timely delivery."
              },
              {
                category: "Services",
                question: "What banking and finance services do you offer?",
                answer: "We offer comprehensive financial technology services including core banking systems, financial security & compliance, payment processing solutions, investment & trading platforms, fraud detection & prevention, financial analytics & reporting, digital banking solutions, and loan management systems. Our services are tailored to your specific needs."
              },
              {
                category: "Support",
                question: "Do you provide ongoing financial system support?",
                answer: "Yes! We provide ongoing financial system support, monitoring, optimization, and security updates. Our team ensures your financial systems stay secure, compliant, and optimized over time."
              },
              {
                category: "Services",
                question: "Can you help with existing banking systems?",
                answer: "Absolutely! We specialize in modernizing and enhancing existing banking systems. We analyze your current infrastructure, identify opportunities, and enhance for improved efficiency, security, and compliance while maintaining system continuity."
              },
              {
                category: "Process",
                question: "What happens during the financial system implementation process?",
                answer: "We provide a dedicated financial technology team that works closely with your team. We handle requirements analysis, solution design, implementation, integration, and optimization. Most financial system processes involve regular check-ins and progress reviews."
              },
              {
                category: "Support",
                question: "How do you ensure financial system security and compliance?",
                answer: "Security and compliance are ensured through comprehensive security frameworks, regulatory compliance checks, regular audits, and 24/7 monitoring. We track metrics like security incidents, compliance scores, and system performance. We provide regular reports and proactive improvements to ensure continuous security and compliance."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto opacity-95 font-medium">
              Join financial institutions that have successfully modernized their banking systems with our services. Get started today with a free consultation.
            </p>

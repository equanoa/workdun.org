...
const services = [
  {
    ...
    description: "Build scalable online stores with modern technologies and best practices."
  },
  {
    icon: <CreditCard className="h-6 w-6" />,
    title: "Payment Integration",
    description: "Seamlessly integrate multiple payment gateways and processing solutions."
  },
  {
    icon: <Package className="h-6 w-6" />,
    title: "Inventory Management",
    description: "Implement robust inventory tracking and management systems."
  },
  {
    icon: <TrendingUp className="h-6 w-6" />,
    title: "Conversion Optimization",
    description: "Optimize your store for maximum conversions and revenue growth."
  },
  {
    icon: <Users className="h-6 w-6" />,
    title: "Customer Experience",
    description: "Create exceptional shopping experiences that keep customers coming back."
  },
  {
    icon: <Globe className="h-6 w-6" />,
    title: "Multi-channel Commerce",
    description: "Expand your reach with omni-channel selling across multiple platforms."
  },
  {
...
const benefits = [
  {
    ...
    description: "Deep experience with Shopify, WooCommerce, Magento, and custom solutions for all business sizes."
  },
  {
    icon: <Zap className="h-8 w-8" />,
    title: "Mobile-First Design",
    description: "Responsive designs that convert on all devices and screen sizes, maximizing your reach."
  },
  {
    icon: <Target className="h-8 w-8" />,
    title: "Performance Optimized",
    description: "Fast-loading stores that provide excellent user experience and SEO benefits for better rankings."
  },
  {
  ...
  },
  {
    ...
    description: "Enterprise-grade security and PCI compliance to protect your customers and business."
  },
  {
    icon: <Globe className="h-8 w-8" />,
    title: "24/7 Support",
    description: "Round-the-clock monitoring and support to ensure your store runs smoothly and efficiently."
  }
]
...
const processSteps = [
  {
    ...
    description: "We analyze your business needs, understand your target market, and develop a comprehensive e-commerce strategy."
  },
  {
    number: "02",
    title: "Design & Development",
    description: "Our experts design and develop custom e-commerce solutions tailored to your unique requirements."
  },
  {
    number: "03",
    title: "Integration & Launch",
    description: "We integrate payment gateways, inventory systems, and launch your store with minimal disruption."
  },
  {
    number: "04",
      ...
      >
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            >
              E-commerce <span className="bg-gradient-to-r from-primary via-blue-400 to-white bg-clip-text text-transparent animate-gradient bg-[length:200%_auto]">Platforms</span>
            </motion.h1>
            <motion.p
            ...
            >
              Build powerful e-commerce solutions that drive sales and growth. We create online stores that are fast, secure, and optimized for conversions.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          >
            {[
              { value: 600, suffix: "+", label: "Stores Launched" },
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                Struggling with <span style={{ color: 'hsl(var(--primary))' }}>Online Sales?</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-6">
                Many businesses face challenges with outdated online stores, poor user experience, and low conversion rates that limit growth.
              </p>
              <ul className="space-y-4 mb-8">
                {[
                  "Outdated online store with poor user experience",
                  "Low conversion rates and high cart abandonment",
                  "Limited payment options and checkout friction",
                  "Poor mobile experience losing mobile customers",
                  "Lack of analytics and insights for optimization"
                ].map((item, index) => (
                  <motion.li
                    key={index}
            ...
            >
              ...
              <p className="text-foreground mb-6">
                Our comprehensive e-commerce solutions create modern, fast, and conversion-optimized online stores that drive sales and growth. We transform your online presence with enterprise-grade e-commerce platforms.
              </p>
              <a
                href="#contact-form"
      ...
      <section className="py-20 bg-white relative">
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Enterprise-grade e-commerce solutions with proven results and comprehensive support.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-4">
                Our e-commerce solutions cover every aspect of online retail, from store development to payment processing and analytics.
              </p>
              <p className="text-sm text-muted-foreground mb-8">
                We deliver end-to-end e-commerce services that transform your online presence and drive sales growth.
              </p>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-6">
                  {[
                    { label: "Store Performance", value: 98 },
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              See how companies have successfully grown their online sales with our e-commerce solutions.
            </p>
          </motion.div>
          ...
          {(() => {
            const testimonials = [
              {
                quote: "The e-commerce platform transformation increased our online sales by 150%. The new store is fast, user-friendly, and conversion-optimized. Our customers love the improved shopping experience.",
                name: "Rajesh Kumar",
              ...
              {
                quote: "Payment integration was seamless. We now support multiple payment methods, reducing cart abandonment by 40% and improving customer satisfaction significantly.",
                name: "Priya Sharma",
                role: "Operations Director, TechStore",
                location: "Delhi, NCR",
                metric: "40% Abandonment Reduction",
                metricLabel: "in cart abandonment"
              },
              {
                quote: "The mobile optimization was outstanding. Our mobile sales have increased by 200%, and the mobile experience is now as good as desktop, if not better.",
                name: "Amit Patel",
                role: "Marketing Manager, MobileFirst",
                location: "Bangalore, Karnataka",
                metric: "200% Mobile Sales",
                metricLabel: "increase in mobile revenue"
              },
              {
                quote: "Inventory management system revolutionized our operations. We can now track inventory in real-time, reducing stockouts and overstock situations dramatically.",
                name: "Anjali Reddy",
                role: "Inventory Manager, RetailPro",
                location: "Hyderabad, Telangana",
                metric: "60% Efficiency Gain",
                metricLabel: "in inventory management"
              },
              {
                quote: "The analytics and reporting features are comprehensive. We can now make data-driven decisions that optimize our product mix and marketing strategies effectively.",
                name: "Vikram Singh",
                role: "Data Analyst, AnalyticsShop",
                location: "Pune, Maharashtra",
                metric: "3x Faster",
                metricLabel: "decision making"
              },
              {
                quote: "Multi-channel commerce integration was seamless. We can now sell across multiple platforms from one dashboard, increasing our reach and sales significantly.",
                name: "Kavita Desai",
                role: "Sales Director, OmniChannel",
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 opacity-60">
              {["FashionRetail", "TechStore", "MobileFirst", "RetailPro", "AnalyticsShop", "OmniChannel"].map((name, i) => (
                <motion.div
                  key={name}
            ...
            {[
              {
                ...
                question: "How long does e-commerce implementation take?",
                answer: "Implementation timelines vary based on project scope and complexity. Most e-commerce stores are launched within 3-6 weeks for standard solutions, while enterprise platforms may take 8-12 weeks. We work closely with you to ensure smooth launch."
              },
              {
                category: "Services",
                question: "What e-commerce services do you offer?",
                answer: "We offer comprehensive e-commerce services including store development, payment integration, inventory management, conversion optimization, customer experience design, multi-channel commerce, analytics, and ongoing support. Our services are tailored to your specific needs."
              },
              {
                category: "Support",
                question: "Do you provide ongoing support?",
                answer: "Yes! We provide 24/7 monitoring and support, regular updates, performance optimization, and proactive maintenance. Our support team ensures your e-commerce store runs smoothly and efficiently."
              },
              {
                category: "Services",
                question: "Can you integrate with our existing systems?",
                answer: "Absolutely! We specialize in e-commerce integration and can seamlessly connect your store with existing ERP systems, inventory management, accounting software, and other business tools. We ensure all your systems work together harmoniously."
              },
              {
                category: "Implementation",
                question: "What happens during the store launch?",
                answer: "We provide a dedicated project manager who works closely with your team. We handle store setup, payment gateway configuration, product migration, and provide comprehensive training. Most launches experience minimal disruption."
              },
              {
                category: "Support",
                question: "How do you ensure security and PCI compliance?",
                answer: "Security is built into every layer of our e-commerce solutions. We implement SSL certificates, secure payment processing, PCI compliance measures, regular security audits, and ongoing monitoring to protect your store and customer data."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto opacity-95 font-medium">
              Join companies that have successfully grown their online sales with our e-commerce solutions. Get started today with a free consultation.
            </p>

...
const services = [
  ...
  },
  {
    ...
    description: "Design AI-powered products with user-centric interfaces that make complex technology accessible."
  },
  {
    icon: <Layout className="h-6 w-6" />,
    title: "SaaS Product Design",
    description: "Build scalable SaaS interfaces that grow with your business and user needs."
  },
  {
    icon: <Sparkles className="h-6 w-6" />,
    title: "Game UI/UX",
    description: "Design immersive gaming experiences with engaging interfaces and intuitive controls."
  },
  {
    icon: <Target className="h-6 w-6" />,
    title: "UX Audits & Redesigns",
    description: "Analyze existing products and redesign for improved usability and conversion."
  },
  {
    icon: <Zap className="h-6 w-6" />,
    title: "Design Systems",
    description: "Create comprehensive design systems that ensure consistency and accelerate development."
  },
  {
    icon: <Users className="h-6 w-6" />,
    title: "Product Strategy",
    description: "Develop product strategies that align with business goals and user needs."
  },
  {
    icon: <CheckCircle className="h-6 w-6" />,
    title: "Prototyping & Testing",
    description: "Build interactive prototypes and conduct user testing to validate designs."
  }
]
...
const benefits = [
  {
    ...
    description: "Every design decision is based on user research and testing, ensuring products that users love."
  },
  {
    icon: <Palette className="h-8 w-8" />,
    title: "Modern Design Practices",
    description: "Latest design trends and best practices applied to every project for cutting-edge results."
  },
  {
    icon: <Globe className="h-8 w-8" />,
    title: "Cross-Platform Expertise",
    description: "Design for web, mobile, desktop, and emerging platforms with seamless experiences."
  },
  {
    icon: <TrendingUp className="h-8 w-8" />,
    title: "Proven Results",
    description: "Track record of successful product launches and redesigns that drive business growth."
  },
  {
    icon: <Zap className="h-8 w-8" />,
    title: "Fast Turnaround",
    description: "Efficient design processes that deliver high-quality results without compromising speed."
  },
  {
    icon: <Shield className="h-8 w-8" />,
    title: "24/7 Support",
    description: "Round-the-clock support to ensure your design needs are met whenever you need them."
  }
]
...
const processSteps = [
  {
    ...
    description: "We analyze your users, market, and business goals to understand what makes a great product."
  },
  {
    number: "02",
    title: "Design & Prototyping",
    description: "Our experts create beautiful, functional designs and interactive prototypes for validation."
  },
  {
    number: "03",
    title: "Testing & Iteration",
    description: "We test designs with real users and iterate based on feedback to ensure optimal results."
  },
  {
    number: "04",
    title: "Implementation & Launch",
    description: "We work closely with development teams to ensure designs are implemented perfectly."
  }
]
    ...
    <div style={{ backgroundColor: 'white' }} className="pt-16">
      ...
      >
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            >
              Product <span className="bg-gradient-to-r from-primary via-blue-400 to-white bg-clip-text text-transparent animate-gradient bg-[length:200%_auto]">Design</span>
            </motion.h1>
            <motion.p
            ...
            >
              Designing experiences that delight users and drive success. We create intuitive, beautiful, and functional products that users love.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          >
            {[
              { value: 800, suffix: "+", label: "Products Designed" },
              { value: 95, suffix: "%", label: "Client Satisfaction" },
              { value: 24, suffix: "/7", label: "Support" },
              { value: 65, suffix: "+", label: "Design Experts" }
            ].map((stat, index) => (
              <motion.div
                key={index}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                Struggling with <span style={{ color: 'hsl(var(--primary))' }}>Product Design?</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-6">
                Many products fail because of poor design. Outdated interfaces, confusing user experiences, and lack of user research lead to low engagement and poor conversion rates.
              </p>
              <ul className="space-y-4 mb-8">
                {[
                  "Outdated interfaces that frustrate users",
                  "Low user engagement and high bounce rates",
                  "Poor conversion rates and user retention",
            ...
            >
              ...
              <p className="text-foreground mb-6">
                Our comprehensive product design services create beautiful, intuitive, and user-centered products that drive engagement and success. We transform your product with modern design practices and proven methodologies.
              </p>
              <a
                href="#contact-form"
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Our Design <span style={{ color: 'hsl(var(--primary))' }}>Services</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Comprehensive product design services from strategy to implementation.
            </p>
          </motion.div>
        ...
        >
          ...
          <p className="text-muted-foreground mb-6">Want to see how these solutions work for your product?</p>
      ...
      <section className="py-20 bg-white relative">
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Why Choose Our Design <span style={{ color: 'hsl(var(--primary))' }}>Services?</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Enterprise-grade design services with proven results and comprehensive support.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 via-white to-gray-50 relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Our Design <span style={{ color: 'hsl(var(--primary))' }}>Process</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              From research to launch, we guide you through every step of your product design journey.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                Comprehensive Design <span style={{ color: 'hsl(var(--primary))' }}>Capabilities</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-4">
                Our design services cover every aspect of product design, from user research to implementation and testing.
              </p>
              <p className="text-sm text-muted-foreground mb-8">
                We deliver end-to-end design solutions that transform your product and drive user engagement.
              </p>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-extrabold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-6">Design Stats</h3>
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              See how companies have successfully transformed their products with our design services.
            </p>
          </motion.div>
          ...
          {(() => {
            const testimonials = [
              {
                quote: "The UI/UX redesign transformed our product completely. User engagement increased by 180%, and our conversion rates improved dramatically. The new design is intuitive, beautiful, and user-friendly.",
                name: "Rahul Mehta",
              ...
              {
                quote: "The design system implementation streamlined our development process. We can now build features 3x faster, and the consistency across our platform is outstanding.",
                name: "Priya Sharma",
                role: "Design Lead, StartupHub",
                location: "Delhi, NCR",
                metric: "3x Faster",
                metricLabel: "development speed"
              },
              {
                quote: "The user research and testing approach was game-changing. We now understand our users better, and our product decisions are data-driven, leading to better outcomes.",
                name: "Amit Patel",
                role: "Founder, UserFirst",
                location: "Bangalore, Karnataka",
                metric: "95% Satisfaction",
                metricLabel: "user satisfaction rate"
              },
              {
                quote: "The SaaS product design was exceptional. Our platform is now scalable, user-friendly, and conversion-optimized. Customer onboarding has improved significantly.",
                name: "Anjali Reddy",
                role: "CEO, CloudSaaS",
                location: "Hyderabad, Telangana",
                metric: "70% Conversion",
                metricLabel: "onboarding conversion rate"
              },
              {
                quote: "The AI product design made complex technology accessible. Our users love the intuitive interface, and adoption rates have increased by 200%.",
                name: "Vikram Singh",
                role: "CTO, AI Solutions",
                location: "Pune, Maharashtra",
                metric: "200% Adoption",
                metricLabel: "increase in user adoption"
              },
              {
                quote: "The UX audit and redesign identified critical issues we didn't know existed. The redesign improved our user retention by 150% and reduced support tickets significantly.",
                name: "Kavita Desai",
                role: "Head of Product, DesignPro",
                location: "Chennai, Tamil Nadu",
                metric: "150% Retention",
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 opacity-60">
              {["TechInnovate", "StartupHub", "UserFirst", "CloudSaaS", "AI Solutions", "DesignPro"].map((name, i) => (
                <motion.div
                  key={name}
            ...
            {[
              {
                ...
                answer: "Design timelines vary based on project scope and complexity. Most product designs are completed within 4-8 weeks for standard projects, while enterprise products may take 10-16 weeks. We work closely with you to ensure timely delivery."
              },
              {
                category: "Services",
                question: "What product design services do you offer?",
                answer: "We offer comprehensive design services including UI/UX design, AI product design, SaaS product design, game UI/UX, UX audits and redesigns, design systems, product strategy, and prototyping and testing. Our services are tailored to your specific product needs."
              },
              {
                category: "Support",
                question: "Do you provide ongoing design support?",
                answer: "Yes! We provide ongoing design support, design system maintenance, design updates, and design consultation. Our team ensures your product design stays current and effective."
              },
              {
                category: "Services",
                question: "Can you redesign an existing product?",
                answer: "Absolutely! We specialize in UX audits and redesigns. We analyze your existing product, identify issues, and redesign for improved usability, conversion, and user satisfaction. We ensure the redesign maintains your brand identity while improving user experience."
              },
              {
                category: "Process",
                question: "What happens during the design process?",
                answer: "We provide a dedicated design team that works closely with your team. We handle user research, design creation, prototyping, user testing, and design handoff. Most design processes involve regular check-ins and feedback sessions."
              },
              {
                category: "Support",
                question: "How do you ensure design quality?",
                answer: "Quality is built into every step of our design process. We conduct user research, create multiple design iterations, test with real users, and follow design best practices. We ensure all designs meet accessibility standards and usability guidelines."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-6 tracking-tight">
              Ready to Design an Exceptional Product?
            </h2>
            <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto opacity-95 font-medium">
              Join companies that have successfully transformed their products with our design services. Get started today with a free consultation.
            </p>

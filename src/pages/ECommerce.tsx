...
const services = [
  {
    ...
    description: "Build powerful Shopify and Shopify Plus stores with custom features and integrations."
  },
  {
    icon: <ShoppingCart className="h-6 w-6" />,
    title: "WooCommerce",
    description: "Custom WooCommerce solutions for WordPress-based e-commerce stores."
  },
  {
    icon: <Package className="h-6 w-6" />,
    title: "Custom Stores",
    description: "Build custom e-commerce platforms tailored to your unique business needs."
  },
  {
    icon: <Globe className="h-6 w-6" />,
    title: "Multi-Store Integration",
    description: "Connect multiple sales channels and marketplaces for unified inventory management."
  },
  {
    icon: <CreditCard className="h-6 w-6" />,
    title: "Payment Processing",
    description: "Integrate multiple payment gateways and ensure secure transaction processing."
  },
  {
    icon: <TrendingUp className="h-6 w-6" />,
    title: "Conversion Optimization",
    description: "Optimize your store for maximum conversions and increased revenue."
  },
  {
    icon: <BarChart className="h-6 w-6" />,
    title: "Analytics & Reporting",
    description: "Track sales, customer behavior, and performance metrics with comprehensive analytics."
  },
  {
...
const benefits = [
  {
    ...
    description: "Deep experience with Shopify, WooCommerce, and custom platforms for seamless store development."
  },
  {
    icon: <TrendingUp className="h-8 w-8" />,
    title: "Conversion Focused",
    description: "Every element designed to maximize conversions and sales with proven optimization strategies."
  },
  {
    icon: <Globe className="h-8 w-8" />,
    title: "Scalable Solutions",
    description: "Build for growth with infrastructure that scales with your business from startup to enterprise."
  },
  {
    icon: <Shield className="h-8 w-8" />,
    title: "Security First",
    description: "Enterprise-grade security to protect customer data and transactions with PCI compliance."
  },
  {
    icon: <BarChart className="h-8 w-8" />,
    title: "Data-Driven Insights",
    description: "Comprehensive analytics and reporting to track performance and optimize your store."
  },
  {
    icon: <Clock className="h-8 w-8" />,
    title: "24/7 Support",
    description: "Round-the-clock support to ensure your store runs smoothly and stays updated."
  }
]
...
const processSteps = [
  {
    ...
    description: "We analyze your business model, target audience, and goals to create a comprehensive e-commerce strategy."
  },
  {
    number: "02",
    title: "Design & Development",
    description: "Our experts create beautiful, conversion-optimized stores with modern technologies and best practices."
  },
  {
    number: "03",
    title: "Integration & Testing",
    description: "We integrate payment gateways, shipping providers, and test thoroughly across devices and browsers."
  },
  {
    number: "04",
    title: "Launch & Optimization",
    description: "We launch your store and provide ongoing optimization, support, and performance monitoring."
  }
]
    ...
    <div style={{ backgroundColor: 'white' }} className="pt-16">
      ...
      >
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            >
              E-<span className="bg-gradient-to-r from-primary via-blue-400 to-white bg-clip-text text-transparent animate-gradient bg-[length:200%_auto]">Commerce</span>
            </motion.h1>
            <motion.p
            ...
            >
              E-commerce experiences built to convert and scale. We create online stores that drive sales and provide exceptional customer experiences.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          >
            {[
              { value: 850, suffix: "+", label: "Stores Built" },
              { value: 97, suffix: "%", label: "Client Satisfaction" },
              { value: 24, suffix: "/7", label: "Support" },
              { value: 60, suffix: "+", label: "E-Commerce Experts" }
            ].map((stat, index) => (
              <motion.div
                key={index}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                Struggling with Your <span style={{ color: 'hsl(var(--primary))' }}>Online Store?</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-6">
                Many businesses face challenges with outdated e-commerce platforms, low conversion rates, and poor customer experiences that limit sales growth.
              </p>
              <ul className="space-y-4 mb-8">
                {[
                  "Outdated store design that doesn't convert visitors",
                  "Low conversion rates losing potential sales",
                  "Poor mobile shopping experience",
                  "Complex checkout process causing cart abandonment",
                  "Limited payment options and integration issues"
                ].map((item, index) => (
                  <motion.li
                    key={index}
            ...
            >
              ...
              <p className="text-foreground mb-6">
                Our comprehensive e-commerce services create modern, conversion-optimized online stores that drive sales. We transform your online presence with cutting-edge platforms and proven strategies.
              </p>
              <a
                href="#contact-form"
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Our E-commerce <span style={{ color: 'hsl(var(--primary))' }}>Solutions</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Complete e-commerce services from platform selection to launch and optimization.
            </p>
          </motion.div>
        ...
        >
          ...
          <p className="text-muted-foreground mb-6">Want to see how these solutions work for your store?</p>
      ...
      <section className="py-20 bg-white relative">
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Why Choose Our E-commerce <span style={{ color: 'hsl(var(--primary))' }}>Services?</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Enterprise-grade e-commerce services with proven results and comprehensive support.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 via-white to-gray-50 relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Our E-commerce <span style={{ color: 'hsl(var(--primary))' }}>Process</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              From strategy to launch, we guide you through every step of your e-commerce journey.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                Comprehensive E-commerce <span style={{ color: 'hsl(var(--primary))' }}>Capabilities</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-4">
                Our e-commerce services cover every aspect of online retail, from platform development to payment integration and optimization.
              </p>
              <p className="text-sm text-muted-foreground mb-8">
                We deliver end-to-end e-commerce solutions that transform your online presence and drive sales growth.
              </p>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-extrabold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-6">E-commerce Stats</h3>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">Enterprise-grade security and PCI compliance. Your customer data is safe with us.</p>
            </div>
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-secondary/20 mb-4" style={{ color: 'hsl(var(--primary))' }}>
              ...
              <p className="text-muted-foreground">We're committed to your success. Our team works closely with you to ensure you achieve your sales goals.</p>
            </div>
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-secondary/20 mb-4" style={{ color: 'hsl(var(--primary))' }}>
              ...
              <p className="text-muted-foreground">Get your store up and running in 2-4 weeks. Start selling immediately.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Trusted by Leading <span style={{ color: 'hsl(var(--primary))' }}>Retailers</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              See how retailers have successfully launched and scaled their online stores with our e-commerce services.
            </p>
          </motion.div>
          ...
          {(() => {
            const testimonials = [
              {
                quote: "The Shopify store launch exceeded our expectations. Sales increased by 300% in the first quarter, and the conversion rate improved by 200%. The store is fast, beautiful, and user-friendly.",
                name: "Rajesh Kumar",
                role: "Founder, FashionHub",
                location: "Mumbai, Maharashtra",
                metric: "300% Sales",
                metricLabel: "increase in first quarter"
              },
              {
                quote: "The WooCommerce integration streamlined our operations significantly. We can now manage inventory across multiple channels, and customer satisfaction has improved dramatically.",
                name: "Priya Sharma",
              ...
              {
                quote: "The conversion optimization was outstanding. Our conversion rate increased by 180%, and cart abandonment decreased by 65%. Revenue has increased significantly.",
                name: "Amit Patel",
                role: "CEO, HomeDecor",
              ...
              {
                quote: "The payment integration made checkout seamless. We now support multiple payment methods, and transaction success rate has increased by 95%.",
                name: "Anjali Reddy",
                role: "Founder, BeautyStore",
                location: "Hyderabad, Telangana",
                metric: "95% Success",
                metricLabel: "transaction success rate"
              },
              {
                quote: "The mobile optimization was a game-changer. Our mobile sales have increased by 250%, and the mobile experience is now as good as desktop.",
                name: "Vikram Singh",
                role: "Director, SportsZone",
                location: "Pune, Maharashtra",
                metric: "250% Mobile",
                metricLabel: "increase in mobile sales"
              },
              {
                quote: "The multi-channel integration gave us confidence. We now sell across multiple platforms, and inventory management is seamless.",
                name: "Kavita Desai",
                role: "Owner, BookWorld",
                location: "Chennai, Tamil Nadu",
                metric: "100% Sync",
                metricLabel: "inventory synchronization"
              }
            ];
      ...
      <section className="py-16 bg-white border-t border-gray-100">
        <div className="mx-auto max-w-7xl px-6">
          ...
          >
            <p className="text-sm font-semibold text-muted-foreground mb-6">Trusted by Leading Retailers Globally</p>
            <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 opacity-60">
              {["FashionHub", "TechGadgets", "HomeDecor", "BeautyStore", "SportsZone", "BookWorld"].map((name, i) => (
                <motion.div
                  key={name}
            ...
            {[
              {
                ...
                answer: "Launch timelines vary based on platform and complexity. Most Shopify stores are completed within 3-6 weeks, while custom platforms may take 8-12 weeks. We work closely with you to ensure timely delivery."
              },
              {
                category: "Services",
                question: "What e-commerce platforms do you work with?",
                answer: "We work with Shopify, WooCommerce, Magento, and custom platforms. We help you choose the best platform for your business needs and provide comprehensive development and integration services."
              },
              {
                category: "Support",
                question: "Do you provide ongoing support after launch?",
                answer: "Yes! We provide ongoing support, maintenance, updates, and optimization. Our team ensures your store runs smoothly, stays updated, and continues to convert visitors into customers."
              },
              {
                category: "Services",
                question: "Can you migrate my existing store to a new platform?",
                answer: "Absolutely! We specialize in store migrations. We handle product data, customer information, order history, and ensure a seamless transition with minimal downtime."
              },
              {
                category: "Process",
                question: "What payment gateways do you integrate?",
                answer: "We integrate all major payment gateways including Stripe, PayPal, Razorpay, PayU, and many others. We ensure secure, PCI-compliant payment processing for your customers."
              },
              {
                category: "Support",
                question: "How do you ensure store security?",
                answer: "Security is built into every layer of our development process. We implement SSL certificates, PCI compliance, security best practices, regular audits, and ongoing monitoring to protect your store and customer data."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto opacity-95 font-medium">
              Join retailers that have successfully launched and scaled their online stores with our e-commerce services. Get started today with a free consultation.
            </p>

...
const services = [
  {
    ...
    description: "Build a beautiful online store optimized for skincare product sales and customer experience."
  },
  {
    icon: <Palette className="h-6 w-6" />,
    title: "Brand Identity",
    description: "Create a compelling brand identity that resonates with your target skincare audience."
  },
  {
    icon: <Package className="h-6 w-6" />,
    title: "Product Photography",
    description: "Professional product photography and visual content for your skincare line."
  },
  {
    icon: <Users className="h-6 w-6" />,
    title: "Customer Management",
    description: "Implement CRM systems to manage customer relationships and loyalty programs."
  },
  {
    icon: <TrendingUp className="h-6 w-6" />,
    title: "Marketing Strategy",
    description: "Develop comprehensive marketing strategies including social media and influencer partnerships."
  },
  {
    icon: <Shield className="h-6 w-6" />,
    title: "Compliance & Regulations",
    description: "Ensure regulatory compliance with FDA, health standards, and international requirements."
  },
  {
    icon: <BarChart className="h-6 w-6" />,
    title: "Analytics & Growth",
    description: "Track performance metrics and optimize for growth with data-driven insights."
  },
  {
    icon: <Heart className="h-6 w-6" />,
    title: "Subscription Services",
    description: "Implement subscription models for recurring revenue and customer retention."
  }
]
...
const benefits = [
  {
    ...
    title: "Fast Launch",
    description: "Get your skincare brand online and selling in weeks with our complete package."
  },
  {
    icon: <Target className="h-8 w-8" />,
    title: "Brand-Focused",
    description: "Every element designed to build trust and resonate with your target audience."
  },
  {
    icon: <Shield className="h-8 w-8" />,
    title: "Compliance Ready",
    description: "Built-in compliance with health and safety regulations from day one."
  },
  {
    icon: <TrendingUp className="h-8 w-8" />,
    title: "Growth-Optimized",
    description: "Strategies and systems designed to scale your business as you grow."
  },
  {
    icon: <Sparkles className="h-8 w-8" />,
    title: "Professional Design",
    description: "Beautiful, modern design that reflects the quality of your products."
  },
  {
    icon: <Zap className="h-8 w-8" />,
    title: "Marketing Included",
    description: "Complete marketing setup including social media and content strategy."
  }
]
...
const processSteps = [
  {
    ...
    description: "Define your brand identity, messaging, and visual design that connects with customers."
  },
  {
    number: "02",
    title: "Store Setup",
    description: "Build your e-commerce store with all necessary features and integrations."
  },
  {
    number: "03",
    title: "Content Creation",
    description: "Create product photography, descriptions, and marketing content."
  },
  {
    number: "04",
    title: "Launch & Market",
    description: "Launch your store and implement marketing strategies to drive sales."
  }
]
...
// Skincare ROI Calculator
function SkincareROICalculator() {
  ...
  const potentialIncrease = convertedAnnualRevenue * 0.45 // 45% average for skincare
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid md:grid-cols-3 gap-6 pt-6 border-t border-border">
        ...
        <div className="text-center p-6 rounded-xl bg-gradient-to-br from-blue-50 to-blue-100/50 border border-secondary/40/50">
          <div className="text-3xl font-extrabold text-primary mb-2">45%</div>
...
// Skincare Comparison Table
function SkincareComparisonTable() {
  const comparisons = [
    { feature: "Brand Development", traditional: "DIY with templates", modernized: "Professional brand identity design" },
    { feature: "Store Setup", traditional: "Basic e-commerce", modernized: "Conversion-optimized store" },
    { feature: "Product Content", traditional: "Phone photos", modernized: "Professional photography & content" },
    { feature: "Compliance", traditional: "Manual research", modernized: "Expert compliance guidance" },
    { feature: "Marketing", traditional: "Basic social media", modernized: "Integrated marketing strategy" },
    { feature: "Customer Management", traditional: "Spreadsheets", modernized: "Automated CRM system" },
    { feature: "Analytics", traditional: "Basic tracking", modernized: "Advanced insights & optimization" },
    { feature: "Support", traditional: "Documentation only", modernized: "Expert support & training" }
  ]
      ...
      <table className="w-full">
        <thead>
          <tr className="border-b-2 border-border">
            ...
            <th className="text-center p-6 font-bold text-primary bg-secondary/20">Professional Package</th>
          </tr>
        </thead>
        <tbody>
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        <div>
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h3 className="text-2xl font-bold text-foreground">Pure Naturals</h3>
          ...
          <p className="text-foreground mb-6 leading-relaxed">
            Pure Naturals, an organic skincare startup, needed a complete brand and e-commerce solution. 
            From concept to ₹30L+ monthly revenue in just 5 months after launch.
          </p>
          
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <CheckCircle className="h-5 w-5 text-primary" />
              <span className="text-foreground">Brand launched in 4 weeks</span>
            </div>
            <div className="flex items-center gap-3">
              <CheckCircle className="h-5 w-5 text-primary" />
            ...
            <div className="flex items-center gap-3">
              <CheckCircle className="h-5 w-5 text-primary" />
              <span className="text-foreground">Compliance documentation completed</span>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          {[
            { label: "Revenue Growth", value: "350%", icon: TrendingUp, color: "from-green-500 to-green-600" },
            { label: "Conversion Rate", value: "4.2%", icon: Target, color: "from-blue-500 to-blue-600" },
            { label: "Time to Launch", value: "4 Weeks", icon: Clock, color: "from-purple-500 to-purple-600" },
            { label: "Customer Rating", value: "4.9/5", icon: Star, color: "from-yellow-500 to-yellow-600" }
          ].map((metric, index) => (
            <motion.div
              key={index}
...
export default function StartSkincareCompany() {
    ...
    <div style={{ backgroundColor: 'white' }} className="pt-16">
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            >
              ...
              <span className="block mt-2">Company Today</span>
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Turn your skincare vision into a successful business. We provide everything you need to launch and grow your skincare brand online.
            </motion.p>
            <motion.div 
          ...
          >
            {[
              { value: null, suffix: "", label: "Weeks to Launch", display: "3-4" },
              { value: 50, suffix: "+", label: "Brands Launched" },
              { value: null, suffix: "", label: "Compliance Ready", display: "100%" },
          ...
          >
            <p className="text-center text-sm text-muted-foreground mb-4">Trusted by skincare brands globally</p>
            <div className="flex flex-wrap items-center justify-center gap-8 opacity-60">
              {["Pure Naturals", "Glow Essentials", "Radiant Skin Co.", "Beauty Bliss"].map((name, i) => (
                <motion.div
                  key={name}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                Ready to Launch Your <span style={{ color: 'hsl(var(--primary))' }}>Skincare Brand?</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-6">
                Starting a skincare company involves more than just great products. You need a professional brand, an online store, compliance documentation, marketing, and more—all while focusing on product development.
              </p>
              <ul className="space-y-4 mb-8">
                {[
                  "Building a professional brand identity and design",
                  "Creating an e-commerce store that converts",
                  "Ensuring regulatory compliance and safety",
                  "Developing marketing strategies and content",
                  "Managing inventory, orders, and fulfillment"
                ].map((item, index) => (
                  <motion.li
                    key={index}
                    initial={{ opacity: 0, x: -20 }}
            ...
            >
              ...
              <p className="text-foreground mb-6">
                We provide a complete skincare startup package. From brand design to store setup, compliance to marketing—we handle everything so you can focus on your products and customers.
              </p>
              <a
                href="#contact-form"
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Complete Skincare <span style={{ color: 'hsl(var(--primary))' }}>Startup Package</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Everything you need to launch and grow your skincare brand successfully.
            </p>
          </motion.div>
        ...
        >
          ...
          <p className="text-muted-foreground mb-6">Want to see how these solutions work for your brand?</p>
      ...
      <section className="py-20 bg-white relative">
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Why Choose Our <span style={{ color: 'hsl(var(--primary))' }}>Package?</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Launch faster with a complete solution designed for skincare brands.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 via-white to-gray-50 relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              From concept to customers, we guide you through every step of launching your brand.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Your complete skincare startup package includes everything you need to launch and start selling.
              </p>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-6">
                  {[
                    { label: "Brand Identity", value: "Complete design" },
                    { label: "E-Commerce Store", value: "Full setup" },
                    { label: "Product Content", value: "Professional" },
                    { label: "Compliance", value: "Documentation" },
                    { label: "Marketing", value: "Strategy & setup" },
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 via-white to-blue-50/20 relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Calculate Your <span style={{ color: 'hsl(var(--primary))' }}>Revenue Potential</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              See how much revenue you could generate with our complete skincare startup package.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              DIY vs <span style={{ color: 'hsl(var(--primary))' }}>Professional Package</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              See the difference between doing it yourself and using our complete professional package.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 via-white to-blue-50/20 relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Real Results from <span style={{ color: 'hsl(var(--primary))' }}>Real Skincare Brands</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              See how Pure Naturals transformed their business with our complete skincare startup package.
            </p>
          </motion.div>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">Get your brand up and running in 3-4 weeks. Start seeing results immediately.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Success Stories from <span style={{ color: 'hsl(var(--primary))' }}>Skincare Founders</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              See how skincare entrepreneurs launched their brands successfully.
            </p>
          </motion.div>
          ...
          {(() => {
            const testimonials = [
              {
                quote: "They helped us launch our organic skincare line in just 4 weeks. The brand design is beautiful, and the store converts really well. We're already seeing repeat customers!",
                name: "Priya Sharma",
                role: "Founder, Pure Naturals",
                location: "Mumbai, Maharashtra",
                metric: "350% Growth",
                metricLabel: "in 5 months"
              },
              {
                quote: "The compliance guidance was invaluable. They made sure we met all FDA requirements before launch. The subscription model they implemented has been a game-changer for our revenue.",
                name: "Anjali Reddy",
                role: "CEO, Glow Essentials",
                location: "Hyderabad, Telangana",
                metric: "4.2% Conversion",
                metricLabel: "rate achieved"
              },
              {
                quote: "As someone new to e-commerce, I was overwhelmed. They guided me through every step and created a beautiful brand that really represents my vision. Highly recommend!",
                name: "Kavita Desai",
              ...
              {
                quote: "The product photography they created is stunning. Our sales increased by 200% after launching with their professional content. The entire process was smooth and professional.",
                name: "Meera Patel",
              ...
              {
                quote: "From brand identity to store setup, they handled everything. We launched in 3 weeks and hit our first ₹10L in sales within 2 months. Incredible results!",
                name: "Riya Kapoor",
                role: "CEO, Natural Glow",
                location: "Delhi, NCR",
                metric: "₹10L Sales",
                metricLabel: "in 2 months"
              },
              {
                quote: "The marketing strategy they developed helped us reach our target audience effectively. Our social media engagement increased by 300% and we're getting consistent orders daily.",
                name: "Sneha Joshi",
                role: "Founder, Organic Radiance",
      ...
      <section className="py-16 bg-white border-y border-gray-100">
        <div className="mx-auto max-w-7xl px-6">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <p className="text-sm font-semibold text-muted-foreground uppercase tracking-wider mb-8">Trusted by Skincare Brands Globally</p>
            <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 opacity-60">
              {["Pure Naturals", "Glow Essentials", "Radiant Skin Co.", "Beauty Bliss", "Natural Glow", "Organic Radiance"].map((name, i) => (
                <motion.div
                  key={name}
          ...
          >
            <div className="p-6 rounded-xl bg-gradient-to-br from-blue-50 to-blue-100/50 border border-secondary/40/50">
              ...
              <div className="text-sm text-muted-foreground font-medium">Brands Launched</div>
            </div>
            <div className="p-6 rounded-xl bg-gradient-to-br from-blue-50 to-blue-100/50 border border-secondary/40/50">
            ...
            <div className="p-6 rounded-xl bg-gradient-to-br from-blue-50 to-blue-100/50 border border-secondary/40/50">
              <div className="text-4xl font-extrabold text-primary mb-2">₹2Cr+</div>
        ...
        <div className="mx-auto max-w-4xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Everything you need to know about launching your skincare brand.
            </p>
          ...
          <div className="space-y-6">
            {[
              {
                category: "Launch",
                question: "How long does it take to launch my skincare brand?",
                answer: "Typically, we can launch your complete skincare brand in 3-4 weeks. This includes brand design, e-commerce store setup, product photography, compliance documentation, and marketing setup. The timeline may vary based on the number of products and specific requirements."
              },
              {
                category: "Launch",
                question: "What's included in the complete package?",
                answer: "Our complete package includes brand identity design, e-commerce store setup and configuration, professional product photography, compliance documentation and guidance, marketing strategy and social media setup, payment processing integration, inventory management system, SEO optimization, and 30 days of post-launch support."
              },
              {
                category: "Launch",
                question: "Do you handle compliance and regulatory requirements?",
                answer: "Yes! We provide comprehensive compliance guidance and documentation support. This includes FDA requirements (if applicable), health and safety standards, labeling requirements, and international compliance for global sales. We ensure your products meet all necessary regulations before launch."
              },
              {
                category: "Pricing",
                question: "Can I customize the package to my specific needs?",
                answer: "Absolutely! We understand every skincare brand is unique. We offer flexible packages that can be customized based on your specific needs, budget, and timeline. Contact us to discuss your requirements and we'll create a tailored solution for you."
              },
              {
                category: "Support",
                question: "What kind of support do you provide after launch?",
                answer: "We provide 30 days of post-launch support included in the package. This includes technical assistance, marketing guidance, and optimization recommendations. Additional ongoing support packages are available for brands that need extended assistance."
              },
              {
                category: "Launch",
                question: "Do you help with product photography?",
                answer: "Yes! Professional product photography is included in our package. We create high-quality product images that showcase your skincare products effectively, including lifestyle shots and detail images that help convert visitors into customers."
              },
              {
                category: "Pricing",
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto opacity-95 font-medium">
              Join successful skincare brands. Get your store up and running in weeks with our comprehensive startup package.
            </p>
            <div className="flex flex-col sm:flex-row gap-5 justify-center items-center">
              ...
              >
                <Button
                  variant="outline"
                  asChild
                  className="border-2 border-white/80 text-white hover:bg-white/20 hover:border-white bg-white/10 text-base font-bold px-10 py-4 h-auto rounded-xl backdrop-blur-sm transition-all duration-300"
                >
                  <a href="/pricing">
                    View Pricing Plans
                  </a>

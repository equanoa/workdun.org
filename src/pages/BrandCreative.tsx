...
const services = [
  {
    ...
    description: "Develop comprehensive brand strategies that define your identity and messaging."
  },
  {
    icon: <Palette className="h-6 w-6" />,
    title: "Logo & Identity",
    description: "Create distinctive logos and visual identities that resonate with your audience."
  },
  {
    icon: <Film className="h-6 w-6" />,
    title: "Motion Graphics",
    description: "Produce engaging animations and motion graphics that bring your brand to life."
  },
  {
    icon: <Camera className="h-6 w-6" />,
    title: "Photography",
    description: "Professional photography and production services for all your marketing needs."
  },
  {
    icon: <Eye className="h-6 w-6" />,
    title: "AR/VR Experiences",
    description: "Create immersive brand experiences with augmented and virtual reality."
  },
  {
    icon: <Sparkles className="h-6 w-6" />,
    title: "Creative Direction",
    description: "Provide creative direction and guidance for all your brand communications."
  },
  {
    icon: <Globe className="h-6 w-6" />,
    title: "Brand Guidelines",
    description: "Develop comprehensive brand guidelines to ensure consistent brand expression."
  },
  {
    icon: <Zap className="h-6 w-6" />,
    title: "Sustainable Design",
    description: "Ethical and sustainable brand design that aligns with your values."
  }
]
...
const benefits = [
  {
    ...
    description: "Brand strategy that aligns with business goals and market positioning for maximum impact."
  },
  {
    icon: <Palette className="h-8 w-8" />,
    title: "Creative Excellence",
    description: "Award-winning creative work that stands out in the marketplace and drives engagement."
  },
  {
    icon: <Globe className="h-8 w-8" />,
    title: "Multi-Platform",
    description: "Brand experiences across all channels and touchpoints for consistent messaging."
  },
  {
    icon: <TrendingUp className="h-8 w-8" />,
    title: "Proven Results",
    description: "Track record of successful brand launches and redesigns that drive business growth."
  },
  {
    icon: <Zap className="h-8 w-8" />,
    title: "Fast Turnaround",
    description: "Efficient creative processes that deliver high-quality results without compromising speed."
  },
  {
    icon: <Clock className="h-8 w-8" />,
    title: "24/7 Support",
    description: "Round-the-clock support to ensure your brand needs are met whenever you need them."
  }
]
...
const processSteps = [
  {
    ...
    description: "We analyze your market, competitors, and audience to understand what makes a great brand."
  },
  {
    number: "02",
    title: "Strategy & Design",
    description: "Our experts create comprehensive brand strategies and beautiful visual identities."
  },
  {
    number: "03",
    title: "Development & Production",
    description: "We produce all brand assets, guidelines, and materials with attention to detail."
  },
  {
    number: "04",
    title: "Launch & Evolution",
    description: "We launch your brand and provide ongoing support to evolve and strengthen it over time."
  }
]
    ...
    <div style={{ backgroundColor: 'white' }} className="pt-16">
      ...
      >
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            >
              Brand & <span className="bg-gradient-to-r from-primary via-blue-400 to-white bg-clip-text text-transparent animate-gradient bg-[length:200%_auto]">Creative</span>
            </motion.h1>
            <motion.p
            ...
            >
              Build a distinctive identity and tell your story with impact. We create brands that resonate, inspire, and drive business success.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          >
            {[
              { value: 750, suffix: "+", label: "Brands Created" },
              { value: 96, suffix: "%", label: "Client Satisfaction" },
              { value: 24, suffix: "/7", label: "Support" },
              { value: 55, suffix: "+", label: "Creative Experts" }
            ].map((stat, index) => (
              <motion.div
                key={index}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                Struggling with Your <span style={{ color: 'hsl(var(--primary))' }}>Brand Identity?</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-6">
                Many businesses face challenges with inconsistent branding, outdated visuals, and unclear messaging that limit recognition and growth.
              </p>
              <ul className="space-y-4 mb-8">
                {[
                  "Inconsistent brand identity across platforms",
                  "Outdated visuals that don't resonate",
                  "Unclear brand messaging and positioning",
                  "Lack of brand guidelines causing confusion",
                  "Poor brand recognition in the marketplace"
                ].map((item, index) => (
                  <motion.li
                    key={index}
            ...
            >
              ...
              <p className="text-foreground mb-6">
                Our comprehensive brand and creative services create distinctive, memorable brands that resonate with audiences. We transform your identity with strategic thinking and creative excellence.
              </p>
              <a
                href="#contact-form"
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Our Creative <span style={{ color: 'hsl(var(--primary))' }}>Services</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Complete brand and creative services from strategy to execution.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white relative">
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Why Choose Our Creative <span style={{ color: 'hsl(var(--primary))' }}>Services?</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Enterprise-grade brand and creative services with proven results and comprehensive support.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 via-white to-gray-50 relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Our Creative <span style={{ color: 'hsl(var(--primary))' }}>Process</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              From discovery to launch, we guide you through every step of your brand journey.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                Comprehensive Brand <span style={{ color: 'hsl(var(--primary))' }}>Capabilities</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-4">
                Our brand and creative services cover every aspect of brand development, from strategy to visual identity and production.
              </p>
              <p className="text-sm text-muted-foreground mb-8">
                We deliver end-to-end brand solutions that transform your identity and drive business growth.
              </p>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-extrabold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-6">Brand Stats</h3>
                <div className="space-y-6">
                  {[
                    { label: "Brand Recognition", value: 94 },
                    { label: "Client Satisfaction", value: 96 },
                    { label: "Creative Quality", value: 98 }
                  ].map((item, index) => (
                    <motion.div
                      key={index}
                      initial={{ opacity: 0, x: -20 }}
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">Enterprise-grade security and data protection. Your brand assets are safe with us.</p>
            </div>
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-secondary/20 mb-4" style={{ color: 'hsl(var(--primary))' }}>
              ...
              <p className="text-muted-foreground">We're committed to your success. Our team works closely with you to ensure you achieve your brand goals.</p>
            </div>
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-secondary/20 mb-4" style={{ color: 'hsl(var(--primary))' }}>
              ...
              <p className="text-muted-foreground">Get your brand identity ready in 2-4 weeks. Start building recognition immediately.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              See how brands have successfully transformed their identity with our creative services.
            </p>
          </motion.div>
          ...
          {(() => {
            const testimonials = [
              {
                quote: "The brand redesign completely transformed our identity. Brand recognition increased by 280%, and customer engagement improved by 200%. The new brand is modern, memorable, and impactful.",
                name: "Rajesh Kumar",
                role: "Founder, StyleBrand",
                location: "Mumbai, Maharashtra",
                metric: "280% Recognition",
                metricLabel: "increase in brand recognition"
              },
              {
                quote: "The logo and identity design exceeded our expectations. We now have a cohesive brand that resonates with our audience, and brand awareness has increased dramatically.",
                name: "Priya Sharma",
              ...
              {
                quote: "The brand guidelines made everything consistent. Our team now has clear direction, and brand consistency has improved by 95% across all touchpoints.",
                name: "Amit Patel",
              ...
              {
                quote: "The motion graphics brought our brand to life. Engagement increased by 250%, and our brand videos are now more impactful and memorable.",
                name: "Anjali Reddy",
                role: "Founder, MediaBrand",
                location: "Hyderabad, Telangana",
                metric: "250% Engagement",
                metricLabel: "increase in brand engagement"
              },
              {
                quote: "The photography elevated our brand significantly. Visual content quality improved, and customer trust has increased by 180%.",
                name: "Vikram Singh",
                role: "Owner, FashionBrand",
                location: "Pune, Maharashtra",
                metric: "180% Trust",
                metricLabel: "increase in customer trust"
              },
              {
                quote: "The AR/VR experiences were innovative. We now have unique brand experiences, and customer interaction has increased by 220%.",
                name: "Kavita Desai",
                role: "Director, InnovationBrand",
                location: "Chennai, Tamil Nadu",
                metric: "220% Interaction",
                metricLabel: "increase in customer interaction"
              }
            ];
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 opacity-60">
              {["StyleBrand", "CreativeAgency", "TechBrand", "MediaBrand", "FashionBrand", "InnovationBrand"].map((name, i) => (
                <motion.div
                  key={name}
        ...
        <div className="mx-auto max-w-4xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Everything you need to know about our brand and creative services.
            </p>
            ...
            {[
              {
                ...
                answer: "Brand development timelines vary based on scope and complexity. Most brand identities are completed within 4-8 weeks, while comprehensive brand systems may take 10-16 weeks. We work closely with you to ensure timely delivery."
              },
              {
                category: "Services",
                question: "What brand and creative services do you offer?",
                answer: "We offer comprehensive brand and creative services including brand strategy, logo & identity design, motion graphics, photography, AR/VR experiences, creative direction, brand guidelines, and sustainable design. Our services are tailored to your specific needs."
              },
              {
                category: "Support",
                question: "Do you provide ongoing brand support?",
                answer: "Yes! We provide ongoing brand support, guidelines maintenance, and creative direction. Our team ensures your brand stays consistent and evolves with your business needs."
              },
              {
                category: "Services",
                question: "Can you redesign an existing brand?",
                answer: "Absolutely! We specialize in brand redesigns. We analyze your existing brand, identify opportunities, and redesign for improved recognition, consistency, and impact while maintaining brand equity."
              },
              {
                category: "Process",
                question: "What happens during the brand development process?",
                answer: "We provide a dedicated creative team that works closely with your team. We handle research, strategy, design, production, and launch. Most brand development processes involve regular check-ins and feedback sessions."
              },
              {
                category: "Support",
                question: "How do you ensure brand consistency?",
                answer: "Consistency is built into every layer of our brand development process. We create comprehensive brand guidelines, provide training, and offer ongoing support to ensure consistent brand expression across all touchpoints."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto opacity-95 font-medium">
              Join brands that have successfully transformed their identity with our creative services. Get started today with a free consultation.
            </p>

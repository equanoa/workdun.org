...
const services = [
  {
    ...
    title: "Fitness Apps",
    description: "Develop mobile applications for workout tracking, nutrition, and progress monitoring."
  },
  {
...
const benefits = [
  {
    ...
    title: "Fitness Industry Focus",
    description: "Specialized solutions designed specifically for fitness and health businesses with deep industry expertise."
  },
  {
    icon: <Users className="h-8 w-8" />,
    title: "Member Engagement",
    description: "Build features that keep members motivated and engaged long-term, driving retention and growth."
  },
  {
    icon: <Zap className="h-8 w-8" />,
    title: "Operational Efficiency",
    description: "Streamline operations and reduce administrative overhead with automated systems and workflows."
  },
  {
    icon: <TrendingUp className="h-8 w-8" />,
    title: "Scalable Growth",
    description: "Solutions that grow with your business from single location to franchise operations."
  },
  {
  ...
  },
  {
    ...
    title: "24/7 Support",
    description: "Round-the-clock monitoring and support to ensure your fitness business runs smoothly."
  }
]
...
const processSteps = [
  {
    ...
    description: "We analyze your fitness business needs, understand your member base, and develop a comprehensive digital strategy."
  },
  {
    number: "02",
    title: "Design & Development",
    description: "Our experts design and develop custom fitness solutions tailored to your unique business requirements."
  },
  {
    number: "03",
    title: "Integration & Launch",
    description: "We integrate member management, payment systems, and launch your platform with minimal disruption."
  },
  {
    number: "04",
    title: "Optimization & Growth",
    description: "Continuous optimization, performance monitoring, and growth strategies to maximize member retention."
  }
]
    ...
    <div style={{ backgroundColor: 'white' }} className="pt-16">
      ...
      >
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            >
              Fitness & <span className="bg-gradient-to-r from-primary via-blue-400 to-white bg-clip-text text-transparent animate-gradient bg-[length:200%_auto]">Health</span>
            </motion.h1>
            <motion.p
            ...
            >
              Transform your fitness business with technology solutions that enhance member experience, streamline operations, and drive growth.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          >
            {[
              { value: 500, suffix: "+", label: "Gyms Served" },
              { value: 98, suffix: "%", label: "Uptime" },
              { value: 24, suffix: "/7", label: "Support" },
              { value: 55, suffix: "+", label: "Expert Team" }
            ].map((stat, index) => (
              <motion.div
                key={index}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                Struggling with <span style={{ color: 'hsl(var(--primary))' }}>Member Retention?</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-6">
                Many fitness businesses face challenges with outdated systems, poor member engagement, and operational inefficiencies that limit growth.
              </p>
              <ul className="space-y-4 mb-8">
                {[
                  "Outdated member management systems with poor user experience",
                  "Low member engagement and high churn rates",
                  "Manual scheduling and administrative overhead",
                  "Lack of data insights for business optimization",
                  "Limited integration with wearable devices and health apps"
                ].map((item, index) => (
                  <motion.li
                    key={index}
            ...
            >
              ...
              <p className="text-foreground mb-6">
                Our comprehensive fitness solutions create modern, engaging, and efficient platforms that drive member retention and growth. We transform your fitness business with enterprise-grade technology.
              </p>
              <a
                href="#contact-form"
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Our Fitness & Health <span style={{ color: 'hsl(var(--primary))' }}>Solutions</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Complete digital solutions for gyms, fitness studios, and health businesses.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white relative">
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Enterprise-grade fitness solutions with proven results and comprehensive support.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 via-white to-gray-50 relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              From strategy to launch, we guide you through every step of your fitness business journey.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                Comprehensive Fitness <span style={{ color: 'hsl(var(--primary))' }}>Capabilities</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-4">
                Our fitness solutions cover every aspect of your business, from member management to health tracking and analytics.
              </p>
              <p className="text-sm text-muted-foreground mb-8">
                We deliver end-to-end solutions that transform your fitness business and drive member retention.
              </p>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-extrabold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-6">Fitness Stats</h3>
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Trusted by Leading <span style={{ color: 'hsl(var(--primary))' }}>Gyms</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              See how fitness businesses have successfully grown with our solutions.
            </p>
          </motion.div>
          ...
          {(() => {
            const testimonials = [
              {
                quote: "The fitness app and member management system transformed our gym operations. Member retention increased by 140%, and our administrative overhead decreased significantly.",
                name: "Arjun Mehta",
                role: "Owner, FitZone Gym",
                location: "Mumbai, Maharashtra",
                metric: "140% Retention",
                metricLabel: "increase in member retention"
              },
              {
                quote: "The scheduling system streamlined our class bookings and trainer appointments. We can now manage multiple locations efficiently, and member satisfaction has improved dramatically.",
                name: "Sneha Kapoor",
                role: "Operations Manager, PowerFit Studio",
                location: "Delhi, NCR",
                metric: "85% Efficiency",
                metricLabel: "operational efficiency gain"
              },
              {
                quote: "Health tracking integration with wearable devices was a game-changer. Our members love tracking their progress, and engagement has increased significantly.",
                name: "Rohan Sharma",
                role: "Founder, HealthFirst Gym",
                location: "Bangalore, Karnataka",
                metric: "200% Engagement",
                metricLabel: "increase in member engagement"
              },
              {
                quote: "The gamification features keep our members motivated and engaged. Challenges and rewards have created a strong community, and member retention is at an all-time high.",
                name: "Anita Desai",
                role: "Marketing Director, ActiveLife",
                location: "Hyderabad, Telangana",
                metric: "95% Retention",
                metricLabel: "member retention rate"
              },
              {
                quote: "Online training platform expanded our reach beyond our physical location. We now offer virtual classes and on-demand content, increasing revenue by 180%.",
                name: "Vikram Patel",
                role: "CEO, VirtualFit",
              ...
              {
                quote: "E-commerce integration for equipment and supplements was seamless. We now have an additional revenue stream, and members appreciate the convenience.",
                name: "Kavita Reddy",
                role: "Business Manager, FitStore",
                location: "Chennai, Tamil Nadu",
                metric: "+60% Revenue",
                metricLabel: "additional revenue stream"
              }
            ];
      ...
      <section className="py-16 bg-white border-t border-gray-100">
        <div className="mx-auto max-w-7xl px-6">
          ...
          >
            <p className="text-sm font-semibold text-muted-foreground mb-6">Trusted by Leading Gyms Globally</p>
            <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 opacity-60">
              {["FitZone Gym", "PowerFit Studio", "HealthFirst Gym", "ActiveLife", "VirtualFit", "FitStore"].map((name, i) => (
                <motion.div
                  key={name}
        ...
        <div className="mx-auto max-w-4xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Everything you need to know about our fitness and health services.
            </p>
            ...
            {[
              {
                ...
                question: "How long does fitness platform implementation take?",
                answer: "Implementation timelines vary based on project scope and complexity. Most fitness platforms are launched within 3-6 weeks for standard solutions, while enterprise platforms may take 8-12 weeks. We work closely with you to ensure smooth launch."
              },
              {
                category: "Services",
                question: "What fitness and health services do you offer?",
                answer: "We offer comprehensive services including fitness apps, member management, scheduling systems, health tracking, analytics, gamification, online training, and e-commerce integration. Our services are tailored to your specific fitness business needs."
              },
              {
                category: "Support",
                question: "Do you provide ongoing support?",
                answer: "Yes! We provide 24/7 monitoring and support, regular updates, performance optimization, and proactive maintenance. Our support team ensures your fitness business runs smoothly and efficiently."
              },
              {
                category: "Services",
                question: "Can you integrate with wearable devices?",
                answer: "Absolutely! We specialize in wearable device integration and can seamlessly connect your platform with fitness trackers, smartwatches, and health apps. We ensure all your health data is synchronized and accessible."
              },
              {
                category: "Implementation",
                question: "What happens during the platform launch?",
                answer: "We provide a dedicated project manager who works closely with your team. We handle platform setup, member data migration, payment gateway configuration, and provide comprehensive training. Most launches experience minimal disruption."
              },
              {
                category: "Support",
                question: "How do you ensure data security and privacy?",
                answer: "Security is built into every layer of our solutions. We implement SSL certificates, secure payment processing, data encryption, regular security audits, and ongoing monitoring to protect your business and member data."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto opacity-95 font-medium">
              Join gyms that have successfully grown with our fitness and health solutions. Get started today with a free consultation.
            </p>

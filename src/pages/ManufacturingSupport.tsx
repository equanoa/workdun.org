...
const services = [
  {
    ...
    title: "OEM Supplier Sourcing",
    description: "Find and coordinate with reliable OEM suppliers for your product manufacturing needs."
  },
  {
    icon: <Package className="h-6 w-6" />,
    title: "ODM Product Development",
    description: "Support for Original Design Manufacturing with end-to-end product development."
  },
  {
    icon: <Wifi className="h-6 w-6" />,
    title: "IoT Manufacturing Integration",
    description: "Integrate IoT capabilities into manufacturing processes for smart production."
  },
  {
    icon: <Settings className="h-6 w-6" />,
    title: "Production Optimization",
    description: "Optimize manufacturing processes for efficiency, quality, and cost-effectiveness."
  },
  {
    icon: <Shield className="h-6 w-6" />,
    title: "Quality Assurance",
    description: "Comprehensive quality control and assurance throughout the manufacturing process."
  },
  {
    icon: <TrendingUp className="h-6 w-6" />,
    title: "Supply Chain Management",
    description: "Manage and optimize your supply chain for seamless production workflows."
  },
  {
    icon: <Zap className="h-6 w-6" />,
    title: "Manufacturing Automation",
    description: "Implement automation solutions to streamline manufacturing operations."
  },
  {
    icon: <CheckCircle className="h-6 w-6" />,
    title: "Compliance & Certification",
    description: "Ensure compliance with industry standards and obtain necessary certifications."
  }
]
...
const benefits = [
  {
    ...
    description: "Experienced manufacturing specialists with deep knowledge of production processes and supply chains."
  },
  {
    icon: <Package className="h-8 w-8" />,
    title: "End-to-End Support",
    description: "From sourcing to production, we handle every aspect of your manufacturing needs."
  },
  {
    icon: <Shield className="h-8 w-8" />,
    title: "Quality Guaranteed",
    description: "Rigorous quality control and assurance processes to ensure product excellence."
  },
  {
    icon: <TrendingUp className="h-8 w-8" />,
    title: "Cost Optimization",
    description: "Optimize manufacturing costs while maintaining quality and meeting production timelines."
  },
  {
    icon: <Settings className="h-8 w-8" />,
    title: "Scalable Solutions",
    description: "Manufacturing solutions designed to scale with your business growth and production needs."
  },
  {
    icon: <Clock className="h-8 w-8" />,
    title: "24/7 Support",
    description: "Round-the-clock support to ensure your manufacturing operations run smoothly."
  }
]
...
const processSteps = [
  {
    ...
    description: "We analyze your manufacturing requirements and source reliable suppliers and partners."
  },
  {
    number: "02",
    title: "Design & Development",
    description: "Our experts support product design and development aligned with manufacturing capabilities."
  },
  {
    number: "03",
    title: "Production & Quality",
    description: "We coordinate production processes and ensure quality standards are met throughout."
  },
  {
    number: "04",
    title: "Optimization & Scaling",
    description: "We optimize manufacturing processes and scale production to meet growing demand."
  }
]
    ...
    <div style={{ backgroundColor: 'white' }} className="pt-16">
      ...
      >
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            >
              Manufacturing <span className="bg-gradient-to-r from-primary via-blue-400 to-white bg-clip-text text-transparent animate-gradient bg-[length:200%_auto]">Support</span>
            </motion.h1>
            <motion.p
            ...
            >
              Bridging product innovation with real-world production. We help you transform ideas into manufactured products with reliable suppliers and optimized processes.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          >
            {[
              { value: 150, suffix: "+", label: "Products Manufactured" },
              { value: 94, suffix: "%", label: "Client Satisfaction" },
              { value: 24, suffix: "/7", label: "Support" },
              { value: 180, suffix: "%", label: "Avg Efficiency Gain" }
            ].map((stat, index) => (
              <motion.div
                key={index}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                Struggling with Manufacturing <span style={{ color: 'hsl(var(--primary))' }}>Challenges?</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-6">
                Many businesses face challenges with supplier sourcing, production quality, and manufacturing processes that limit product success.
              </p>
              <ul className="space-y-4 mb-8">
                {[
                  "Difficulty finding reliable OEM suppliers",
                  "Poor production quality and consistency",
                  "Inefficient manufacturing processes",
                  "Lack of manufacturing expertise and support",
            ...
            >
              ...
              <p className="text-foreground mb-6">
                Our comprehensive manufacturing support services bridge product innovation with real-world production. We transform your ideas into manufactured products with reliable suppliers and optimized processes.
              </p>
              <a
                href="#contact-form"
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Our Manufacturing <span style={{ color: 'hsl(var(--primary))' }}>Services</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Comprehensive manufacturing support from sourcing to production.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white relative">
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Why Choose Our Manufacturing <span style={{ color: 'hsl(var(--primary))' }}>Support?</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Enterprise-grade manufacturing support with proven results and comprehensive assistance.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 via-white to-gray-50 relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Our Manufacturing <span style={{ color: 'hsl(var(--primary))' }}>Process</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              From sourcing to scaling, we guide you through every step of your manufacturing journey.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                Comprehensive Manufacturing <span style={{ color: 'hsl(var(--primary))' }}>Capabilities</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-4">
                Our manufacturing support services cover every aspect of production, from supplier sourcing to quality assurance and scaling.
              </p>
              <p className="text-sm text-muted-foreground mb-8">
                We deliver end-to-end manufacturing solutions that transform your ideas into successful products.
              </p>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-extrabold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-6">Manufacturing Stats</h3>
                <div className="space-y-6">
                  {[
                    { label: "Efficiency Gain", value: 180 },
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">Enterprise-grade security and data protection. Your manufacturing data is safe with us.</p>
            </div>
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-secondary/20 mb-4" style={{ color: 'hsl(var(--primary))' }}>
              ...
              <p className="text-muted-foreground">We're committed to your success. Our team works closely with you to ensure you achieve your manufacturing goals.</p>
            </div>
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-secondary/20 mb-4" style={{ color: 'hsl(var(--primary))' }}>
                <Clock className="h-8 w-8" />
              </div>
              <h3 className="text-xl font-bold text-foreground mb-2">Quick Turnaround</h3>
              <p className="text-muted-foreground">Get your products manufactured in 4-8 weeks. Start production immediately.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              See how businesses have successfully manufactured products with our support services.
            </p>
          </motion.div>
          ...
          {(() => {
            const testimonials = [
              {
                quote: "The OEM supplier sourcing completely transformed our production. Supplier reliability improved by 260%, and production efficiency increased by 195%. The manufacturing approach delivered measurable results.",
                name: "Rajesh Kumar",
                role: "Founder, ProductCorp",
                location: "Mumbai, Maharashtra",
                metric: "260% Reliability",
                metricLabel: "improvement in supplier reliability"
              },
              {
                quote: "The ODM product development exceeded our expectations. We now have quality products that meet specifications, and production quality has increased dramatically.",
                name: "Priya Sharma",
                role: "CEO, DesignManufacturing",
                location: "Delhi, NCR",
                metric: "92% Quality",
                metricLabel: "production quality improvement"
              },
              {
                quote: "The IoT manufacturing integration made everything connected. Our production now has smart monitoring, and operational efficiency has improved by 98%.",
                name: "Amit Patel",
                role: "Founder, SmartManufacturing",
                location: "Bangalore, Karnataka",
                metric: "98% Efficiency",
                metricLabel: "operational efficiency improvement"
              },
              {
                quote: "The production optimization streamlined our manufacturing. Production speed improved by 220%, and our manufacturing processes are now more effective.",
                name: "Anjali Reddy",
                role: "Founder, OptimizeProduction",
                location: "Hyderabad, Telangana",
                metric: "220% Speed",
                metricLabel: "improvement in production speed"
              },
              {
                quote: "The quality assurance elevated our product quality significantly. Defect rates decreased, and customer satisfaction has increased by 185%.",
                name: "Vikram Singh",
                role: "Owner, QualityProducts",
                location: "Pune, Maharashtra",
                metric: "185% Satisfaction",
                metricLabel: "increase in customer satisfaction"
              },
              {
                quote: "The supply chain management was comprehensive. We now have optimized supply chains, and production reliability has increased by 240%.",
                name: "Kavita Desai",
                role: "Director, SupplyChainFirm",
                location: "Chennai, Tamil Nadu",
                metric: "240% Reliability",
                metricLabel: "increase in production reliability"
              }
            ];
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 opacity-60">
              {["ProductCorp", "DesignManufacturing", "SmartManufacturing", "OptimizeProduction", "QualityProducts", "SupplyChainFirm"].map((name, i) => (
                <motion.div
                  key={name}
        ...
        <div className="mx-auto max-w-4xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Everything you need to know about our manufacturing support services.
            </p>
          ...
          <div className="space-y-6">
            {[
              {
                category: "Process",
                question: "How long does manufacturing support take?",
                answer: "Manufacturing support timelines vary based on scope and complexity. Most manufacturing projects are completed within 4-8 weeks, while comprehensive ODM developments may take 10-16 weeks. We work closely with you to ensure timely delivery."
              },
              {
                category: "Services",
                question: "What manufacturing support services do you offer?",
                answer: "We offer comprehensive manufacturing support services including OEM supplier sourcing, ODM product development, IoT manufacturing integration, production optimization, quality assurance, supply chain management, manufacturing automation, and compliance & certification. Our services are tailored to your specific needs."
              },
              {
                category: "Support",
                question: "Do you provide ongoing manufacturing support?",
                answer: "Yes! We provide ongoing manufacturing support, production optimization, and quality monitoring. Our team ensures your manufacturing processes stay optimized and continue to deliver quality products over time."
              },
              {
                category: "Services",
                question: "Can you help with existing manufacturing processes?",
                answer: "Absolutely! We specialize in optimizing and enhancing existing manufacturing processes. We analyze your current setup, identify opportunities, and enhance for improved efficiency, quality, and cost-effectiveness while maintaining production continuity."
              },
              {
                category: "Process",
                question: "What happens during the manufacturing support process?",
                answer: "We provide a dedicated manufacturing team that works closely with your team. We handle requirements analysis, supplier sourcing, design support, production coordination, quality assurance, and optimization. Most manufacturing processes involve regular check-ins and progress reviews."
              },
              {
                category: "Support",
                question: "How do you ensure manufacturing quality?",
                answer: "Quality is ensured through comprehensive quality control, regular inspections, supplier audits, and 24/7 support. We track metrics like defect rates, production efficiency, and customer satisfaction. We provide regular reports and proactive improvements to ensure continuous quality."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto opacity-95 font-medium">
              Join businesses that have successfully manufactured products with our support services. Get started today with a free consultation.
            </p>

...
const services = [
  {
    ...
    description: "Design and develop smart connected devices that seamlessly integrate with your ecosystem."
  },
  {
    icon: <Cpu className="h-6 w-6" />,
    title: "Embedded Systems",
    description: "Build robust embedded solutions for real-time monitoring and control applications."
  },
  {
    icon: <Radio className="h-6 w-6" />,
    title: "Sensor Integration",
    description: "Integrate advanced sensors for data collection, monitoring, and automation."
  },
  {
    icon: <Network className="h-6 w-6" />,
    title: "Connectivity Solutions",
    description: "Implement reliable connectivity protocols including WiFi, Bluetooth, LoRaWAN, and cellular."
  },
  {
    icon: <Smartphone className="h-6 w-6" />,
    title: "Mobile App Integration",
    description: "Create mobile applications to control and monitor your IoT devices remotely."
  },
  {
    icon: <Zap className="h-6 w-6" />,
    title: "Edge Computing",
    description: "Deploy edge computing solutions for real-time data processing and decision-making."
  },
  {
    icon: <Shield className="h-6 w-6" />,
    title: "IoT Security",
    description: "Implement comprehensive security measures to protect your connected devices and data."
  },
  {
    icon: <Database className="h-6 w-6" />,
    title: "Data Analytics",
    description: "Transform IoT data into actionable insights with advanced analytics and visualization."
  }
]
...
const benefits = [
  {
    ...
    description: "From hardware design to cloud integration, we handle every aspect of IoT development with comprehensive solutions."
  },
  {
    icon: <Zap className="h-8 w-8" />,
    title: "Scalable Architecture",
    description: "Build solutions that scale from pilot to enterprise deployment seamlessly, growing with your business needs."
  },
  {
    icon: <Target className="h-8 w-8" />,
    title: "Security First",
    description: "Enterprise-grade security built into every layer of your IoT solution, protecting devices and data."
  },
  {
    icon: <Users className="h-8 w-8" />,
    title: "Proven Track Record",
    description: "Successfully deployed IoT solutions across multiple industries and use cases with measurable results."
  },
  {
    icon: <Shield className="h-8 w-8" />,
    title: "Real-Time Monitoring",
    description: "Advanced monitoring and analytics capabilities for real-time insights and proactive management."
  },
  {
    icon: <Globe className="h-8 w-8" />,
    title: "24/7 Support",
    description: "Round-the-clock monitoring and support to ensure optimal performance and reliability of your IoT infrastructure."
  }
]
...
const processSteps = [
  {
    ...
    description: "We analyze your business needs, understand your use cases, and identify opportunities for IoT implementation."
  },
  {
    number: "02",
    title: "Solution Design",
    description: "Our experts design custom IoT solutions tailored to your unique requirements, from device to cloud."
  },
  {
    number: "03",
    title: "Implementation & Integration",
    description: "We implement IoT solutions with minimal disruption and seamlessly integrate with your existing systems."
  },
  {
    number: "04",
    title: "Support & Optimization",
    description: "Continuous monitoring, optimization, and support to ensure your IoT infrastructure drives maximum value."
  }
]
...
export default function IoTConnectedDevices() {
    ...
    <div style={{ backgroundColor: 'white' }} className="pt-16">
      ...
      >
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            >
              IoT & <span className="bg-gradient-to-r from-primary via-blue-400 to-white bg-clip-text text-transparent animate-gradient bg-[length:200%_auto]">Connected Devices</span>
            </motion.h1>
            <motion.p
            ...
            >
              Transform your business with intelligent IoT solutions. We design and develop connected devices that enable real-time monitoring, automation, and data-driven decision making.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          >
            {[
              { value: 300, suffix: "+", label: "IoT Devices Deployed" },
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                Struggling with <span style={{ color: 'hsl(var(--primary))' }}>Disconnected Systems?</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-6">
                Many businesses face challenges with manual processes, lack of real-time data, and disconnected systems that limit efficiency and growth.
              </p>
              <ul className="space-y-4 mb-8">
                {[
                  "Manual data collection and monitoring processes",
            ...
            >
              ...
              <p className="text-foreground mb-6">
                Our comprehensive IoT solutions connect your devices, automate processes, and provide real-time insights that drive efficiency and growth. We transform your operations with intelligent connected systems.
              </p>
              <a
                href="#contact-form"
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Our IoT <span style={{ color: 'hsl(var(--primary))' }}>Solutions</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              End-to-end IoT services from device design to cloud integration and analytics.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white relative">
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Why Choose Our IoT <span style={{ color: 'hsl(var(--primary))' }}>Services?</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Enterprise-grade IoT solutions with proven results and comprehensive support.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 via-white to-gray-50 relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              From analysis to implementation, we guide you through every step of your IoT transformation.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                Comprehensive IoT <span style={{ color: 'hsl(var(--primary))' }}>Capabilities</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-4">
                Our IoT solutions cover every aspect of connected device infrastructure, from device development to cloud integration and real-time analytics.
              </p>
              <p className="text-sm text-muted-foreground mb-8">
                We deliver end-to-end IoT services that transform your operations and drive intelligent automation.
              </p>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-extrabold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-6">IoT Stats</h3>
                <div className="space-y-6">
                  {[
                    { label: "Device Reliability", value: 99.8 },
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              See how companies have successfully transformed their operations with our IoT solutions.
            </p>
          </motion.div>
          ...
          {(() => {
            const testimonials = [
              {
                quote: "The IoT implementation revolutionized our manufacturing operations. We've reduced downtime by 45% and improved efficiency significantly. Real-time monitoring has transformed how we operate.",
                name: "Rajesh Kumar",
                role: "Operations Director, SmartManufacturing",
                location: "Mumbai, Maharashtra",
                metric: "45% Downtime Reduction",
                metricLabel: "in manufacturing operations"
              },
              {
                quote: "Their IoT device development exceeded our expectations. The connected sensors provide real-time data that helps us make informed decisions and optimize our processes.",
                name: "Priya Sharma",
                role: "IoT Lead, TechSolutions",
                location: "Delhi, NCR",
                metric: "60% Efficiency Gain",
                metricLabel: "in process optimization"
              },
              {
                quote: "The edge computing implementation was comprehensive. We now have real-time data processing at the edge, reducing latency and improving response times dramatically.",
                name: "Amit Patel",
                role: "CTO, EdgeTech",
                location: "Bangalore, Karnataka",
                metric: "80% Latency Reduction",
                metricLabel: "in data processing"
              },
              {
                quote: "IoT security implementation was thorough. All our connected devices are now protected with enterprise-grade security, giving us peace of mind.",
                name: "Anjali Reddy",
                role: "Security Manager, ConnectedDevices",
                location: "Hyderabad, Telangana",
                metric: "100% Security Compliance",
                metricLabel: "audit success"
              },
              {
                quote: "The mobile app integration was outstanding. We can now monitor and control all our IoT devices remotely, improving our operational flexibility.",
                name: "Vikram Singh",
                role: "Product Manager, IoTInnovations",
                location: "Pune, Maharashtra",
                metric: "+90% Remote Control",
                metricLabel: "device management"
              },
              {
                quote: "Their data analytics solutions have transformed how we use IoT data. We can now predict maintenance needs and optimize operations proactively.",
                name: "Kavita Desai",
                role: "Data Director, AnalyticsPro",
                location: "Chennai, Tamil Nadu",
                metric: "3x Predictive Accuracy",
                metricLabel: "maintenance predictions"
              }
            ];
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 opacity-60">
              {["SmartManufacturing", "TechSolutions", "EdgeTech", "ConnectedDevices", "IoTInnovations", "AnalyticsPro"].map((name, i) => (
                <motion.div
                  key={name}
        ...
        <div className="mx-auto max-w-4xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Everything you need to know about our IoT services.
            </p>
            ...
            {[
              {
                ...
                question: "How long does IoT implementation take?",
                answer: "Implementation timelines vary based on project scope and complexity. Most IoT projects are completed within 3-6 weeks for standard solutions, while enterprise deployments may take 8-12 weeks. We work closely with you to ensure smooth deployment."
              },
              {
                category: "Services",
                question: "What IoT services do you offer?",
                answer: "We offer comprehensive IoT services including device development, embedded systems, sensor integration, connectivity solutions, mobile app integration, edge computing, IoT security, and data analytics. Our services are tailored to your specific needs."
              },
              {
                category: "Support",
                question: "Do you provide ongoing support?",
                answer: "Yes! We provide 24/7 monitoring and support, regular firmware updates, performance optimization, and proactive maintenance. Our support team ensures your IoT infrastructure runs smoothly and efficiently."
              },
              {
                category: "Services",
                question: "Can you integrate with our existing systems?",
                answer: "Absolutely! We specialize in IoT integration and can seamlessly connect your IoT devices with existing systems, cloud platforms, and databases. We ensure all your systems work together harmoniously."
              },
              {
                category: "Implementation",
                question: "What happens during the deployment?",
                answer: "We provide a dedicated project manager who works closely with your team. We handle device setup, network configuration, cloud integration, and provide comprehensive training. Most deployments experience minimal disruption."
              },
              {
                category: "Support",
                question: "How do you ensure IoT security?",
                answer: "Security is built into every layer of our IoT solutions. We implement device authentication, encrypted communication, secure cloud connections, regular security updates, and ongoing monitoring to protect your IoT infrastructure."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-6 tracking-tight">
              Ready to Connect Your Business with IoT?
            </h2>
            <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto opacity-95 font-medium">
              Join companies that have successfully transformed their operations with our IoT solutions. Get started today with a free consultation.
            </p>

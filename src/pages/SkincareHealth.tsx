...
const services = [
  {
    ...
    description: "Build beautiful online stores for skincare products with seamless shopping experiences."
  },
  {
  ...
  },
  {
    ...
    description: "Track products, ingredients, and batch numbers with comprehensive inventory systems."
  },
  {
    icon: <Palette className="h-6 w-6" />,
    title: "Brand & Design",
    description: "Create compelling brand identities and visual designs that resonate with your audience."
  },
  {
  ...
  },
  {
    ...
    description: "Develop content strategies and campaigns that educate and engage customers."
  },
  {
    icon: <TrendingUp className="h-6 w-6" />,
    title: "Growth & Analytics",
    description: "Leverage data analytics to optimize marketing, sales, and customer retention."
  },
  {
...
const benefits = [
  {
    ...
    description: "Deep understanding of skincare and health industry challenges and opportunities for sustainable growth."
  },
  {
    icon: <Shield className="h-8 w-8" />,
    title: "Compliance Focus",
    description: "Ensure your business meets all regulatory requirements and standards with comprehensive compliance solutions."
  },
  {
    icon: <Users className="h-8 w-8" />,
    title: "Customer-Centric",
    description: "Build solutions that prioritize customer experience and engagement, driving loyalty and retention."
  },
  {
    icon: <TrendingUp className="h-8 w-8" />,
    title: "Growth-Focused",
    description: "Strategies and solutions designed to scale your business effectively from startup to enterprise."
  },
  {
    icon: <Zap className="h-8 w-8" />,
    title: "Fast Implementation",
    description: "Get your skincare business online quickly with streamlined processes and rapid deployment."
  },
  {
    icon: <Globe className="h-8 w-8" />,
    title: "24/7 Support",
    description: "Round-the-clock monitoring and support to ensure your business runs smoothly and efficiently."
  }
]
...
const processSteps = [
  {
    ...
    description: "We analyze your skincare business needs, understand your target market, and develop a comprehensive digital strategy."
  },
  {
    number: "02",
    title: "Design & Development",
    description: "Our experts design and develop custom solutions tailored to your unique skincare brand requirements."
  },
  {
    number: "03",
    title: "Integration & Launch",
    description: "We integrate payment systems, inventory management, and launch your platform with minimal disruption."
  },
  {
    number: "04",
    title: "Optimization & Growth",
    description: "Continuous optimization, performance monitoring, and growth strategies to maximize your revenue."
  }
]
...
export default function SkincareHealth() {
      ...
      >
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            >
              Skincare & <span className="bg-gradient-to-r from-primary via-blue-400 to-white bg-clip-text text-transparent animate-gradient bg-[length:200%_auto]">Health</span>
            </motion.h1>
            <motion.p
            ...
            >
              Empowering skincare and health brands with digital solutions that drive growth, enhance customer experience, and ensure compliance.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          >
            {[
              { value: 400, suffix: "+", label: "Brands Served" },
              { value: 98, suffix: "%", label: "Uptime" },
              { value: 24, suffix: "/7", label: "Support" },
              { value: 45, suffix: "+", label: "Expert Team" }
            ].map((stat, index) => (
              <motion.div
                key={index}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                Struggling with <span style={{ color: 'hsl(var(--primary))' }}>Digital Growth?</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-6">
                Many skincare and health brands face challenges with outdated systems, poor customer experience, and compliance issues that limit growth.
              </p>
              <ul className="space-y-4 mb-8">
                {[
                  "Outdated e-commerce platforms with poor user experience",
                  "Limited customer engagement and retention strategies",
                  "Complex inventory and batch tracking challenges",
                  "Compliance and regulatory concerns",
                  "Lack of data-driven insights for growth"
                ].map((item, index) => (
                  <motion.li
                    key={index}
            ...
            >
              ...
              <p className="text-foreground mb-6">
                Our comprehensive skincare and health solutions create modern, compliant, and customer-focused digital platforms that drive growth. We transform your brand with enterprise-grade solutions.
              </p>
              <a
                href="#contact-form"
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Our Skincare & Health <span style={{ color: 'hsl(var(--primary))' }}>Solutions</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Comprehensive digital services tailored to the unique needs of skincare and health businesses.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white relative">
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Enterprise-grade skincare and health solutions with proven results and comprehensive support.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 via-white to-gray-50 relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              From strategy to launch, we guide you through every step of your skincare business journey.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                Comprehensive Skincare <span style={{ color: 'hsl(var(--primary))' }}>Capabilities</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-4">
                Our skincare and health solutions cover every aspect of your business, from e-commerce to compliance and customer management.
              </p>
              <p className="text-sm text-muted-foreground mb-8">
                We deliver end-to-end solutions that transform your skincare brand and drive growth.
              </p>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-extrabold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-6">Skincare Stats</h3>
                <div className="space-y-6">
                  {[
                    { label: "Brand Performance", value: 96 },
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              See how skincare and health brands have successfully grown with our solutions.
            </p>
          </motion.div>
          ...
          {(() => {
            const testimonials = [
              {
                quote: "The e-commerce platform transformation increased our online sales by 180%. The new store is beautiful, user-friendly, and conversion-optimized. Our customers love the improved shopping experience.",
                name: "Meera Patel",
                role: "Founder, GlowSkincare",
                location: "Mumbai, Maharashtra",
                metric: "180% Sales Increase",
                metricLabel: "in online revenue"
              },
              {
                quote: "Customer management system revolutionized our operations. We can now track customer preferences, manage loyalty programs, and personalize experiences effectively.",
                name: "Ananya Sharma",
                role: "CEO, HealthGlow",
                location: "Delhi, NCR",
                metric: "65% Retention",
              ...
              {
                quote: "The compliance and regulatory support was outstanding. We now meet all FDA and health standards, giving us confidence to expand globally.",
                name: "Rahul Verma",
                role: "Operations Director, PureCare",
                location: "Bangalore, Karnataka",
                metric: "100% Compliance",
                metricLabel: "regulatory compliance"
              },
              {
                quote: "Inventory management system transformed our operations. We can now track products, ingredients, and batch numbers in real-time, reducing waste and improving efficiency.",
                name: "Priya Reddy",
                role: "Inventory Manager, NaturalBeauty",
                location: "Hyderabad, Telangana",
                metric: "50% Efficiency Gain",
                metricLabel: "in inventory management"
              },
              {
                quote: "The subscription service implementation was seamless. We now have recurring revenue streams and improved customer retention significantly.",
                name: "Vikram Singh",
                role: "Marketing Manager, SkinCarePlus",
                location: "Pune, Maharashtra",
                metric: "3x Revenue",
                metricLabel: "recurring revenue growth"
              },
              {
                quote: "Content marketing strategies increased our brand awareness and engagement. Our educational content drives customer trust and sales effectively.",
                name: "Kavita Desai",
                role: "Content Director, WellnessBrand",
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 opacity-60">
              {["GlowSkincare", "HealthGlow", "PureCare", "NaturalBeauty", "SkinCarePlus", "WellnessBrand"].map((name, i) => (
                <motion.div
                  key={name}
        ...
        <div className="mx-auto max-w-4xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Everything you need to know about our skincare and health services.
            </p>
            ...
            {[
              {
                ...
                question: "How long does skincare platform implementation take?",
                answer: "Implementation timelines vary based on project scope and complexity. Most skincare e-commerce platforms are launched within 3-6 weeks for standard solutions, while enterprise platforms may take 8-12 weeks. We work closely with you to ensure smooth launch."
              },
              {
                category: "Services",
                question: "What skincare and health services do you offer?",
                answer: "We offer comprehensive services including e-commerce platforms, customer management, inventory tracking, compliance management, brand design, content marketing, subscription services, and analytics. Our services are tailored to your specific skincare brand needs."
              },
              {
                category: "Support",
                question: "Do you provide ongoing support?",
                answer: "Yes! We provide 24/7 monitoring and support, regular updates, performance optimization, and proactive maintenance. Our support team ensures your skincare business runs smoothly and efficiently."
              },
              {
                category: "Services",
                question: "Can you help with regulatory compliance?",
                answer: "Absolutely! We specialize in skincare and health compliance and can help ensure your business meets FDA, health standards, and international regulatory requirements. We provide comprehensive compliance solutions."
              },
              {
                category: "Implementation",
                question: "What happens during the platform launch?",
                answer: "We provide a dedicated project manager who works closely with your team. We handle platform setup, payment gateway configuration, product migration, compliance checks, and provide comprehensive training. Most launches experience minimal disruption."
              },
              {
                category: "Support",
                question: "How do you ensure data security and privacy?",
                answer: "Security is built into every layer of our solutions. We implement SSL certificates, secure payment processing, data encryption, regular security audits, and ongoing monitoring to protect your business and customer data."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto opacity-95 font-medium">
              Join brands that have successfully grown with our skincare and health solutions. Get started today with a free consultation.
            </p>

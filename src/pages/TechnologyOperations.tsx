...
const services = [
  {
    ...
    description: "Design and implement scalable cloud infrastructures on AWS, Azure, or GCP."
  },
  {
  ...
  },
  {
    ...
    description: "Manage hosting infrastructure and provide 24/7 monitoring and support."
  },
  {
    icon: <Shield className="h-6 w-6" />,
    title: "Security & Penetration Testing",
    description: "Protect your systems with comprehensive security audits and penetration testing."
  },
  {
    icon: <CheckCircle className="h-6 w-6" />,
    title: "QA & Testing",
    description: "Ensure quality with comprehensive testing services including automated and manual testing."
  },
  {
    icon: <Users className="h-6 w-6" />,
    title: "Product Management",
    description: "Strategic product management and roadmapping to guide development priorities."
  },
  {
    icon: <GitBranch className="h-6 w-6" />,
    title: "Systems Integration",
    description: "Integrate legacy systems with modern platforms and third-party services."
  },
  {
    icon: <Settings className="h-6 w-6" />,
    title: "ERP/CRM Implementation",
    description: "Implement and customize ERP/CRM systems like Salesforce, HubSpot, and more."
  }
]
...
const benefits = [
  {
    ...
    title: "Expert Team",
    description: "Certified professionals with expertise across all major platforms and technologies for reliable operations."
  },
  {
    icon: <Clock className="h-8 w-8" />,
    title: "24/7 Support",
    description: "Round-the-clock monitoring and support to ensure optimal performance and reliability."
  },
  {
    icon: <Shield className="h-8 w-8" />,
    title: "Security First",
    description: "Enterprise-grade security practices to protect your infrastructure and data from threats."
  },
  {
    icon: <TrendingUp className="h-8 w-8" />,
    title: "Cost Optimization",
    description: "Optimize infrastructure costs while maintaining performance and reliability for maximum efficiency."
  },
  {
    icon: <Server className="h-8 w-8" />,
    title: "Scalable Solutions",
    description: "Infrastructure and systems designed to scale with your business growth and changing needs."
  },
  {
    icon: <CheckCircle className="h-8 w-8" />,
    title: "Quality Assurance",
    description: "Comprehensive testing and quality assurance to ensure reliable and high-performing systems."
  }
]
...
const processSteps = [
  {
    ...
    description: "We assess your current infrastructure and technology needs to develop comprehensive plans."
  },
  {
    number: "02",
    title: "Design & Architecture",
    description: "Our experts design scalable architectures and solutions tailored to your requirements."
  },
  {
    number: "03",
    title: "Implementation & Deployment",
    description: "We implement and deploy solutions with best practices and comprehensive testing."
  },
  {
    number: "04",
    title: "Monitoring & Optimization",
    description: "We provide ongoing monitoring, support, and optimization to ensure peak performance."
  }
]
    ...
    <div style={{ backgroundColor: 'white' }} className="pt-16">
      ...
      >
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            >
              Technology & <span className="bg-gradient-to-r from-primary via-blue-400 to-white bg-clip-text text-transparent animate-gradient bg-[length:200%_auto]">Operations</span>
            </motion.h1>
            <motion.p
            ...
            >
              Build a resilient, scalable tech foundation that powers innovation. We provide comprehensive technology and operations services to keep your business running smoothly.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          >
            {[
              { value: 420, suffix: "+", label: "Infrastructures Deployed" },
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                Struggling with Technology <span style={{ color: 'hsl(var(--primary))' }}>Operations?</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-6">
                Many businesses face challenges with unreliable infrastructure, security vulnerabilities, and lack of operational expertise that limit growth.
              </p>
              <ul className="space-y-4 mb-8">
                {[
                  "Unreliable infrastructure and frequent downtime",
                  "Security vulnerabilities and compliance issues",
                  "Lack of operational expertise and support",
                  "Poor scalability and performance bottlenecks",
                  "Inefficient DevOps and deployment processes"
                ].map((item, index) => (
                  <motion.li
                    key={index}
            ...
            >
              ...
              <p className="text-foreground mb-6">
                Our comprehensive technology and operations services build resilient, scalable infrastructure. We transform your technology foundation to power innovation and ensure smooth operations.
              </p>
              <a
                href="#contact-form"
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Our Technology <span style={{ color: 'hsl(var(--primary))' }}>Services</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Complete technology and operations services from infrastructure to support.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white relative">
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Why Choose Our Technology <span style={{ color: 'hsl(var(--primary))' }}>Services?</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Enterprise-grade technology and operations with proven results and comprehensive support.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 via-white to-gray-50 relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Our Technology <span style={{ color: 'hsl(var(--primary))' }}>Process</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              From assessment to optimization, we guide you through every step of your technology journey.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                Comprehensive Technology <span style={{ color: 'hsl(var(--primary))' }}>Capabilities</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-4">
                Our technology and operations services cover every aspect of infrastructure, from cloud architecture to security and monitoring.
              </p>
              <p className="text-sm text-muted-foreground mb-8">
                We deliver end-to-end technology solutions that transform your infrastructure and drive business growth.
              </p>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-extrabold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-6">Technology Stats</h3>
                <div className="space-y-6">
                  {[
                    { label: "Uptime Guarantee", value: 99 },
                    { label: "Client Satisfaction", value: 97 },
                    { label: "Infrastructure Success", value: 95 }
                  ].map((item, index) => (
                    <motion.div
                      key={index}
                      initial={{ opacity: 0, x: -20 }}
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">Enterprise-grade security and data protection. Your infrastructure is safe with us.</p>
            </div>
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-secondary/20 mb-4" style={{ color: 'hsl(var(--primary))' }}>
              ...
              <p className="text-muted-foreground">We're committed to your success. Our team works closely with you to ensure you achieve your technology goals.</p>
            </div>
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-secondary/20 mb-4" style={{ color: 'hsl(var(--primary))' }}>
              ...
              <p className="text-muted-foreground">Get your infrastructure ready in 2-4 weeks. Start operating immediately.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              See how businesses have successfully improved their technology operations with our services.
            </p>
          </motion.div>
          ...
          {(() => {
            const testimonials = [
              {
                quote: "The cloud architecture completely transformed our infrastructure. Scalability improved by 260%, and operational costs decreased by 35%. The expert approach delivered measurable results.",
                name: "Rajesh Kumar",
                role: "CTO, TechCorp",
                location: "Mumbai, Maharashtra",
                metric: "260% Scalability",
                metricLabel: "improvement in scalability"
              },
              {
                quote: "The DevOps implementation exceeded our expectations. We now have automated deployments that are faster and more reliable, and deployment time has decreased dramatically.",
                name: "Priya Sharma",
                role: "Engineering Director, DevStartup",
                location: "Delhi, NCR",
                metric: "80% Faster",
                metricLabel: "deployment time reduction"
              },
              {
                quote: "The security and penetration testing made everything secure. Our systems now have comprehensive security, and security incidents have decreased by 95%.",
                name: "Amit Patel",
                role: "Security Lead, SecureTech",
                location: "Bangalore, Karnataka",
                metric: "95% Reduction",
                metricLabel: "security incidents reduction"
              },
              {
                quote: "The hosting and monitoring streamlined our operations. Uptime improved by 220%, and our infrastructure is now more reliable and effective.",
                name: "Anjali Reddy",
                role: "Founder, CloudPlatform",
                location: "Hyderabad, Telangana",
                metric: "220% Uptime",
                metricLabel: "improvement in uptime"
              },
              {
                quote: "The QA and testing elevated our quality significantly. Bug rates decreased, and product quality has improved by 190%.",
                name: "Vikram Singh",
                role: "Owner, QualityTech",
                location: "Pune, Maharashtra",
                metric: "190% Quality",
                metricLabel: "improvement in product quality"
              },
              {
                quote: "The systems integration was comprehensive. We now have integrated systems, and operational efficiency has increased by 250%.",
                name: "Kavita Desai",
                role: "Director, IntegrationFirm",
                location: "Chennai, Tamil Nadu",
                metric: "250% Efficiency",
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 opacity-60">
              {["TechCorp", "DevStartup", "SecureTech", "CloudPlatform", "QualityTech", "IntegrationFirm"].map((name, i) => (
                <motion.div
                  key={name}
        ...
        <div className="mx-auto max-w-4xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Everything you need to know about our technology and operations services.
            </p>
          ...
          <div className="space-y-6">
            {[
              {
                category: "Process",
                question: "How long does infrastructure deployment take?",
                answer: "Deployment timelines vary based on scope and complexity. Most infrastructure deployments are completed within 2-4 weeks, while comprehensive cloud migrations may take 6-12 weeks. We work closely with you to ensure timely delivery."
              },
              {
                category: "Services",
                question: "What technology and operations services do you offer?",
                answer: "We offer comprehensive technology and operations services including cloud architecture, DevOps, hosting & monitoring, security & penetration testing, QA & testing, product management, systems integration, and ERP/CRM implementation. Our services are tailored to your specific needs."
              },
              {
                category: "Support",
                question: "Do you provide ongoing technology support?",
                answer: "Yes! We provide ongoing technology support, 24/7 monitoring, and infrastructure optimization. Our team ensures your infrastructure stays optimized and continues to perform reliably over time."
              },
              {
                category: "Services",
                question: "Can you optimize existing infrastructure?",
                answer: "Absolutely! We specialize in optimizing existing infrastructure. We analyze your current setup, identify opportunities, and optimize for improved performance, security, and cost efficiency while maintaining reliability."
              },
              {
                category: "Process",
                question: "What happens during the deployment process?",
                answer: "We provide a dedicated technology team that works closely with your team. We handle assessment, design, implementation, testing, and deployment. Most deployment processes involve regular check-ins and progress reviews."
              },
              {
                category: "Support",
                question: "How do you ensure infrastructure reliability?",
                answer: "Reliability is ensured through comprehensive monitoring, automated failover, regular backups, and 24/7 support. We track metrics like uptime, performance, and security. We provide regular reports and proactive maintenance to ensure continuous reliability."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto opacity-95 font-medium">
              Join businesses that have successfully improved their technology operations with our services. Get started today with a free consultation.
            </p>

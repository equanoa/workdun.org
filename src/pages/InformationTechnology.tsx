...
const services = [
  {
    ...
    description: "Build tailored software solutions that address your unique business challenges and drive growth."
  },
  {
    icon: <Server className="h-6 w-6" />,
    title: "Enterprise Solutions",
    description: "Scalable enterprise-grade systems designed to handle complex business operations and workflows."
  },
  {
    icon: <Cloud className="h-6 w-6" />,
    title: "Cloud Infrastructure",
    description: "Migrate to the cloud with confidence. We design and implement secure, scalable cloud architectures."
  },
  {
    icon: <Database className="h-6 w-6" />,
    title: "Data Management",
    description: "Optimize your data infrastructure with robust database solutions and data analytics platforms."
  },
  {
  ...
  },
  {
    ...
    description: "Seamlessly connect your existing systems and third-party applications for unified operations."
  },
  {
    icon: <Globe className="h-6 w-6" />,
    title: "API Development",
    description: "Build robust APIs that enable seamless communication between your systems and external services."
  },
  {
    icon: <Smartphone className="h-6 w-6" />,
    title: "Mobile Solutions",
    description: "Develop native and cross-platform mobile applications that enhance user engagement."
  }
]
...
const benefits = [
  {
    ...
    description: "Future-proof architectures that grow with your business needs and adapt to changing requirements."
  },
  {
    icon: <Zap className="h-8 w-8" />,
    title: "Operational Efficiency",
    description: "Automate processes, reduce manual work, and streamline operations for maximum productivity."
  },
  {
    icon: <Target className="h-8 w-8" />,
    title: "Customized Approach",
    description: "Tailored solutions designed specifically for your business challenges and objectives."
  },
  {
    icon: <Users className="h-8 w-8" />,
    title: "Expert Team",
    description: "Certified professionals with deep expertise across all technology domains and platforms."
  },
  {
    icon: <Shield className="h-8 w-8" />,
    title: "Security First",
    description: "Enterprise-grade security built into every layer of your technology infrastructure."
  },
  {
...
const processSteps = [
  {
    ...
    description: "We analyze your current infrastructure, understand your business needs, and identify opportunities for improvement."
  },
  {
    number: "02",
    title: "Solution Design",
    description: "Our experts design custom solutions tailored to your unique requirements and business objectives."
  },
  {
    number: "03",
    title: "Implementation & Integration",
    description: "We implement solutions with minimal disruption and seamlessly integrate with your existing systems."
  },
  {
    number: "04",
    ...
    <div style={{ backgroundColor: 'white' }} className="pt-16">
      ...
      >
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            >
              Information <span className="bg-gradient-to-r from-primary via-blue-400 to-white bg-clip-text text-transparent animate-gradient bg-[length:200%_auto]">Technology</span>
            </motion.h1>
            <motion.p
            ...
            >
              Empowering businesses with cutting-edge IT solutions that drive innovation, enhance efficiency, and accelerate digital transformation. We deliver enterprise-grade technology services tailored to your unique needs.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                Struggling with <span style={{ color: 'hsl(var(--primary))' }}>Outdated Technology?</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-6">
                Many businesses face challenges with legacy systems, inefficient processes, and technology gaps that hinder growth and innovation.
              </p>
            ...
            >
              ...
              <p className="text-foreground mb-6">
                Our comprehensive IT solutions modernize your infrastructure, integrate your systems, and provide scalable, secure technology that drives business growth. We transform your technology landscape with enterprise-grade solutions.
              </p>
              <a
                href="#contact-form"
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Our IT <span style={{ color: 'hsl(var(--primary))' }}>Solutions</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Comprehensive technology services designed to modernize your infrastructure and streamline operations.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white relative">
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">
              Why Choose Our IT <span style={{ color: 'hsl(var(--primary))' }}>Services?</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Enterprise-grade solutions with proven results and comprehensive support.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 via-white to-gray-50 relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              From analysis to implementation, we guide you through every step of your digital transformation.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white relative overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                Comprehensive IT <span style={{ color: 'hsl(var(--primary))' }}>Capabilities</span>
              </h2>
              <p className="text-lg text-muted-foreground mb-4">
                Our IT solutions cover every aspect of modern technology infrastructure, from cloud migration to security compliance and system integration.
              </p>
              <p className="text-sm text-muted-foreground mb-8">
                We deliver end-to-end technology services that transform your business operations and drive digital innovation.
              </p>
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              See how companies have successfully transformed their IT infrastructure with our solutions.
            </p>
          </motion.div>
          ...
          {(() => {
            const testimonials = [
              {
                quote: "The cloud migration transformed our entire infrastructure. We've reduced costs by 40% and improved system performance significantly. The team's expertise was evident throughout the process.",
                name: "Rajesh Kumar",
                role: "CTO, TechCorp India",
                location: "Mumbai, Maharashtra",
                metric: "40% Cost Reduction",
                metricLabel: "in infrastructure costs"
              },
              {
                quote: "Their custom software development exceeded our expectations. The solution perfectly addresses our unique business needs and has streamlined our operations dramatically.",
                name: "Priya Sharma",
                role: "IT Director, Digital Solutions",
                location: "Delhi, NCR",
                metric: "60% Efficiency Gain",
                metricLabel: "in operations"
              },
              {
                quote: "The cybersecurity implementation was comprehensive and thorough. We now have enterprise-grade security protecting all our systems and data. Highly recommended!",
                name: "Amit Patel",
              ...
              {
                quote: "System integration was seamless. All our disparate systems now work together perfectly, eliminating data silos and improving collaboration across teams.",
                name: "Anjali Reddy",
              ...
              {
                quote: "The mobile app development was outstanding. Our customer engagement has increased significantly, and the app has become a key differentiator for our business.",
                name: "Vikram Singh",
                role: "Product Manager, InnovateNow",
                location: "Pune, Maharashtra",
                metric: "+80% Engagement",
                metricLabel: "customer engagement"
              },
              {
                quote: "Their data management solutions have revolutionized how we handle information. We can now make data-driven decisions with confidence and speed.",
                name: "Kavita Desai",
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 opacity-60">
              {["TechCorp India", "Digital Solutions", "FinanceFirst", "GlobalTech", "InnovateNow", "AnalyticsPro"].map((name, i) => (
                <motion.div
                  key={name}
            ...
            {[
              {
                ...
                question: "How long does IT implementation take?",
                answer: "Implementation timelines vary based on project scope and complexity. Most projects are completed within 2-4 weeks for standard solutions, while enterprise implementations may take 6-12 weeks. We work closely with you to minimize disruption to your operations."
              },
              {
                category: "Services",
                question: "What IT services do you offer?",
                answer: "We offer comprehensive IT services including custom software development, cloud infrastructure, cybersecurity, system integration, data management, API development, and mobile solutions. Our services are tailored to your specific business needs."
              },
              {
                category: "Support",
                question: "Do you provide ongoing support?",
                answer: "Yes! We provide 24/7 technical support, regular system updates, performance monitoring, and proactive maintenance. Our support team is always available to ensure your systems run smoothly and efficiently."
              },
              {
                category: "Services",
                question: "Can you integrate with our existing systems?",
                answer: "Absolutely! We specialize in system integration and can seamlessly connect your existing systems with new solutions. We ensure all your systems work together harmoniously for unified operations."
              },
              {
                category: "Implementation",
                question: "What happens during the transition?",
                answer: "We provide a dedicated project manager who works closely with your team. We handle data migration, system setup, integration, and provide comprehensive training. Most implementations experience zero downtime during the transition."
              },
              {
                category: "Support",
                question: "How do you ensure security and compliance?",
                answer: "Security is built into every layer of our solutions. We implement enterprise-grade security measures, conduct regular audits, ensure compliance with industry standards, and provide ongoing security monitoring and updates."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
        ...
        <div className="mx-auto max-w-7xl px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto opacity-95 font-medium">
              Join companies that have successfully modernized with our IT solutions. Get started today with a free consultation.
            </p>
